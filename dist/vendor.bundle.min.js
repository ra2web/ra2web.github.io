System.registerDynamic("fontfaceobserver", [], !0, function (e, t, n) {
  this || self;
  !(function () {
    function e(e, t) {
...
var O = D;
function P(e, t) {
  if (((e.prototype = ma(t.prototype)), (e.prototype.constructor = e), O))
    O(e, t);
  else
    for (var n in t)
      if ("prototype" != n)
...
function Q(e, t) {
  if (t) {
    for (var n = pa, r = e.split("."), i = 0; i < r.length - 1; i++) {
      var a = r[i];
      (a in n || (n[a] = {}), (n = n[a]));
    }
    (a = t((i = n[(r = r[r.length - 1])]))) != i &&
      null != a &&
      oa(n, r, { configurable: !0, writable: !0, value: a });
  }
}
(Q("Object.is", function (e) {
  return (
    e ||
    function (e, t) {
  ...
  Q("Array.prototype.includes", function (e) {
    return (
      e ||
      function (e, t) {
        var n = this;
        ...
        var r = n.length,
          i = t || 0;
        for (0 > i && (i = Math.max(i + r, 0)); i < r; i++) {
          var a = n[i];
  ...
  Q("String.prototype.codePointAt", function (e) {
    return (
      e ||
      function (e) {
        if (null == this)
        ...
        var t = this.length;
        if (0 <= (e = Number(e) || 0) && e < t) {
          e |= 0;
          var n = this.charCodeAt(e);
          return 55296 > n || 56319 < n || e + 1 === t
            ? n
            : 56320 > (e = this.charCodeAt(e + 1)) || 57343 < e
              ? n
              : 1024 * (n - 55296) + e + 9216;
        }
      }
  ...
  Q("Array.prototype.fill", function (e) {
    return (
      e ||
      function (e, t, n) {
        var r = this.length || 0;
...
function X(e) {
  ...
  function L(e, t, n) {
    var r = [];
    return (
      z(e, t, r, (n = void 0 === n ? 0 : n), n + Math.ceil(t.h / 8)),
      r[0]
    );
  }
  ...
  ((d.prototype.ga = function (e, t, n) {
    ...
    (h.prototype.j = function (e, t, n, r, i) {
      ...
      for (i = a.join(""), a = this.offset + t - 1, r = t; a >= t; )
        ((e[a] = parseInt(i.substring(0, 8), 2)),
          (i = i.substring(8)),
          a--,
          r++);
      return r;
    ...
    (u.prototype.Ua = function (e) {
      ...
      return (
        (t = t.concat(I(e.chunkId), M(n.length + 1, this.a), n)).push(0),
        t
      );
    }),
  ...
  (P(n, o),
    ...
    (n.prototype.toIMAADPCM = function () {
      ...
      this.H();
      var e = new Int16Array(j(this.data.samples.length, 2));
      (z(this.data.samples, this.f, e, 0, this.data.samples.length),
        this.m(
          ...
          (function (e) {
            for (
              ...
              (0 == o % 505 &&
                0 != o &&
                (n.set(w(r, t), i), (i += 256), (r = []), a++),
                r.push(e[o]));
            return ((e = e.length / 2) % 2 && e++, n.slice(0, e + 512 + 4 * a));
          })(e),
          { container: this.v() },
        ));
    }),
    (n.prototype.fromIMAADPCM = function (e) {
      if (((e = void 0 === e ? "16" : e), 1 < this.fmt.numChannels)) {
        if (2 < this.fmt.numChannels)
          throw Error("Only 1 or 2 channels are supported");
        for (
          var t = this.data.samples.length / 2,
            n = new Uint8Array(t),
            r = new Uint8Array(t),
            i = 0,
            a = 0;
          ...
          (a && 0 == a % 4 && (i += 4),
            (n[a] = this.data.samples[i + a]),
            (r[a] = this.data.samples[i + a + 4]));
        t = [b(n, this.fmt.blockAlign / 2), b(r, this.fmt.blockAlign / 2)];
      } else t = b(this.data.samples, this.fmt.blockAlign);
      (this.m(this.fmt.numChannels, this.fmt.sampleRate, "16", t, {
        container: this.v(),
      }),
        "16" != e && this.toBitDepth(e));
    }),
    (n.prototype.toALaw = function () {
      this.H();
      var e = new Int16Array(j(this.data.samples.length, 2));
      (z(this.data.samples, this.f, e, 0, this.data.samples.length),
        this.m(
          ...
          (function (e) {
            for (
              var t = new Uint8Array(e.length), n = 0, r = e.length;
              n < r;
              n++
            ) {
              var i = n,
                a = e[n],
                o = (~(a = -32768 == a ? -32767 : a) >> 8) & 128;
              if ((o || (a *= -1), 32635 < a && (a = 32635), 256 <= a)) {
                var l = W[(a >> 8) & 127];
                a = (l << 4) | ((a >> (l + 3)) & 15);
              } else a >>= 4;
              t[i] = a ^ o ^ 85;
    ...
    (n.prototype.fromALaw = function (e) {
      ((e = void 0 === e ? "16" : e),
        this.m(
          this.fmt.numChannels,
          this.fmt.sampleRate,
          ...
          (function (e) {
            for (
              var t = new Int16Array(e.length), n = 0, r = e.length;
              n < r;
              n++
            ) {
              var i = n,
    ...
    (n.prototype.fromMuLaw = function (e) {
      ((e = void 0 === e ? "16" : e),
        this.m(
          this.fmt.numChannels,
          this.fmt.sampleRate,
    ...
    (n.prototype.toBitDepth = function (e, t) {
      var n = e,
        r = this.bitDepth;
      (void 0 === t ||
        t ||
        ("32f" != e && (n = this.f.h.toString()), (r = "" + this.f.h)),
        this.T());
      var i = this.getSamples(!0),
        a = new Float64Array(i.length),
        o = r;
      if (-1 < ["32f", "64"].indexOf(o) && -1 < ["32f", "64"].indexOf(n))
        a.set(i);
      else {
        (y(o),
          y(n),
        ...
        var l = {
          fa: Math.pow(2, parseInt(o, 10)) / 2,
          da: Math.pow(2, parseInt(n, 10)) / 2,
          ea: Math.pow(2, parseInt(o, 10)) / 2 - 1,
          ca: Math.pow(2, parseInt(n, 10)) / 2 - 1,
        };
        (g(o, i, !0), (o = 0));
        for (var s = i.length; o < s; o++) a[o] = r(i[o], l);
        g(n, a, !1);
      }
      this.m(this.fmt.numChannels, this.fmt.sampleRate, e, a, {
        container: this.v(),
      });
    }),
    (n.prototype.toSampleRate = function (e, t) {
      this.xa(e);
      var n = this.getSamples(),
        r = [];
      if (n.constructor === Float64Array) r = D(n, this.fmt.sampleRate, e, t);
      else
        for (var i = 0; i < n.length; i++)
          r.push(D(n[i], this.fmt.sampleRate, e, t));
      this.m(this.fmt.numChannels, e, this.bitDepth, r, {
        container: this.v(),
      });
    }),
    (n.prototype.xa = function (e) {
      if (
        1 > e ||
        4294967295 < (this.fmt.bitsPerSample / 8) * this.fmt.numChannels * e
      )
    ...
    (n.prototype.H = function () {
      (this.T(), "16" != this.bitDepth && this.toBitDepth("16"));
    }),
    ...
    (n.prototype.m = function (e, t, n, r, i) {
      var a = new o();
    ...
    P(t, n),
    (t.prototype.fromBase64 = function (e) {
      this.fromBuffer(
        (function (e) {
          for (var t = new Uint8Array(256), n = 0; 64 > n; n++)
            t[
          ...
          ((n = 0.75 * e.length),
            ...
            (n = new Uint8Array(n)));
          for (var r = 0, i = 0; r < e.length; r += 4) {
            var a = t[e.charCodeAt(r)],
              o = t[e.charCodeAt(r + 1)],
              l = t[e.charCodeAt(r + 2)],
    ...
    (t.prototype.toBase64 = function () {
      for (var e = this.toBuffer(), t = "", n = 0; n < e.length; n += 3)
        ((t +=
      ...
      return (
        2 == e.length % 3
          ...
          : 1 == e.length % 3 && (t = t.substring(0, t.length - 2) + "=="),
        t
      );
    }),
    (t.prototype.toDataURI = function () {
      return "data:audio/wav;base64," + this.toBase64();
    }),
    (t.prototype.fromDataURI = function (e) {
      this.fromBase64(e.replace("data:audio/wav;base64,", ""));
    }),
    (e.WaveFile = t),
...
("object" == typeof exports && "undefined" != typeof module
  ? X(exports)
  : System.registerDynamic("wavefile", [], !1, function (e, t, n) {
      return "function" == typeof X ? X.call(t, t) : X;
    }),
  (function () {
    const e = "undefined" != typeof process && "node" === process.release.name;
    function t() {
    ...
    function n(e) {
      ((this.buffer = e),
        (this.byteView = new Uint8Array(e)),
        (this.header = {
          version: 0,
          bpp: 0,
          xmin: 0,
    ...
    ((n.prototype = {
      _readLEWord: function (e) {
        return this.byteView[e] | (this.byteView[e + 1] << 8);
      },
      isPCXFile: function () {
        return this.byteView && 10 === this.byteView[0];
      },
      readHeader: function () {
        ...
        return (
          this.isPCXFile()
            ? ((this.header = Object.assign(this.header, {
                ...
                palette: e
                  ? new Uint8Array(this.buffer.buffer, 16, 48)
                  : new Uint8Array(this.buffer, 16, 48),
              ...
              n.resolve(this.header))
            : n.reject("Not a PCX File"),
          n.promise
        );
      },
      _isRLE: function (e) {
        return 3 === this.byteView[e] >> 6;
      },
      _lengthRLE: function (e) {
        return 63 & this.byteView[e];
      },
      getPalette: function () {
        if (
          8 === this.header.bpp &&
          12 === this.byteView[this.buffer.byteLength - 769]
        )
          this.palette = new Uint8Array(
            this.buffer.slice(this.buffer.byteLength - 768),
          );
        else {
          if (1 !== this.header.bpp) throw "Could not find 256 color palette.";
          this.palette = this.header.palette;
        }
      },
      setColorFromPalette: function (e, t) {
        const n = this.palette,
          r = 3 * t;
        let i = this.pixels;
        ((i[e] = n[r]),
          (i[e + 1] = n[r + 1]),
        ...
        for (
          this.getPalette(),
            this.temp = new Uint8Array(
              new ArrayBuffer(this.width * this.height),
            ),
            this.pixels = new Uint8Array(
              new ArrayBuffer(this.width * this.height * 4),
            ),
            t = 0;
          t < this.temp.byteLength;
          t++
        )
          this.temp[t] = 0;
        for (var a = 0; a < this.height; a++)
          for (t = 0; t < this.planes; t++) {
            n = this.width * a;
            for (var o = 0; o < this.header.bpr; o++)
              if (
                (0 === r &&
                  (this._isRLE(e)
                    ? ((r = this._lengthRLE(e)),
                ...
                for (var l = 0; l < 8; l++) {
                  ...
                  ((this.temp[n + l] |= s << t),
                    t === this.planes - 1 &&
                      this.setColorFromPalette(4 * (n + l), this.temp[n + l]));
                }
                n += 8;
              }
          }
      },
      decode8bpp: function (e) {
        (1 === this.planes && this.getPalette(),
          (this.pixels = new Uint8Array(
            new ArrayBuffer(this.width * this.height * 4),
          )));
        for (
          var t = 128, n = 0, r = 0, i = 0, a = 0, o = 0;
          o < this.height;
          o++
        )
          for (n = 0; n < this.planes; n++) {
            r = 4 * this.width * o + n;
            for (var l = 0; l < this.header.bpr; l++)
              (0 === i &&
                (this._isRLE(t)
                  ? ((i = this._lengthRLE(t)),
                    (a = this.byteView[t + 1]),
                    (t += 2))
                  : ((i = 1), (a = this.byteView[t++]))),
                i--,
                l < this.width &&
                  (3 === this.planes
                    ? ((this.pixels[r] = a),
                      n === this.planes - 1 && (this.pixels[r + 1] = 255))
                    : this.setColorFromPalette(r, a),
                  (r += 4)));
          }
      },
    }),
      "undefined" != typeof module && void 0 !== module.exports
        ? (module.exports = n)
        : System.registerDynamic("pcx-js", [], !1, function (e, t, r) {
            return function () {
              return n;
            }.call(this);
          }));
  ...
  (function (e, t) {
    "object" == typeof exports && "undefined" != typeof module
      ? (module.exports = t())
      : System.registerDynamic("stats.js", [], !1, function (e, n, r) {
          return t.call(this);
        });
  })(0, function () {
    var e = function () {
        ...
        n(0),
        {
          ...
          begin: function () {
            ...
            if (
              (u.update(e - a, 200),
              e > o + 1e3 &&
                (s.update((1e3 * l) / (e - o), 100), (o = e), (l = 0), c))
            ) {
          ...
          v.fillRect(f, h, d, p),
          {
            ...
            update: function (s, y) {
              ((r = Math.min(r, s)),
                ...
                v.drawImage(m, f + o, h, d - o, p, f, h, d - o, p),
                v.fillRect(f + d - o, h, o, p),
                (v.fillStyle = n),
                (v.globalAlpha = 0.9),
                v.fillRect(f + d - o, h, o, a((1 - s / y) * p)));
            },
          }
        );
      }),
  ...
  (function (e) {
    ...
    l.prototype = {
      ...
      time: function (e) {
        "string" == typeof e &&
          e.length > 0 &&
          this.invoke(n.TIME, [e, "start"]);
      },
      timeEnd: function (e) {
        "string" == typeof e && e.length > 0 && this.invoke(n.TIME, [e, "end"]);
      },
      invoke: function (e, n) {
        t && this.enabledFor(e) && t(n, a({ level: e }, this.context));
      },
    };
    var s,
      u = new l({ filterLevel: n.OFF });
    (((s = n).enabledFor = i(u, u.enabledFor)),
      (s.debug = i(u, u.debug)),
      (s.time = i(u, u.time)),
      (s.timeEnd = i(u, u.timeEnd)),
      (s.info = i(u, u.info)),
      (s.warn = i(u, u.warn)),
      (s.error = i(u, u.error)),
      (s.log = s.info),
      ...
      (n.setLevel = function (e) {
        for (var t in (u.setLevel(e), r))
          r.hasOwnProperty(t) && r[t].setLevel(e);
      }),
      (n.getLevel = function () {
        return u.getLevel();
      }),
      (n.get = function (e) {
        return r[e] || (r[e] = new l(a({ name: e }, u.context)));
      }),
              ...
              a.level === n.TIME
                ? ((o = (a.name ? "[" + a.name + "] " : "") + i[0]),
                  "start" === i[1]
                    ...
                    : console.timeEnd
                      ? console.timeEnd(o)
                      : r(l, [o + ": " + (new Date().getTime() - t[o]) + "ms"]))
                : (a.level === n.WARN && console.warn
                    ? (l = console.warn)
                    : a.level === n.ERROR && console.error
                      ? (l = console.error)
                      : a.level === n.INFO && console.info
                        ? (l = console.info)
                        : a.level === n.DEBUG &&
                          console.debug &&
                          (l = console.debug),
      ...
      System.registerDynamic("js-logger", [], !1, function (e, t, r) {
        return "function" == typeof n ? n.call(this) : n;
      }));
  })(),
  (function (e, t) {
    "object" == typeof exports && "undefined" != typeof module
      ? t(exports)
      : System.registerDynamic("react", [], !1, function (e, n, r) {
          return t.call(n, n);
        });
  })(0, function (e) {
    function t(e) {
    ...
    function a(e, t, n) {
      ...
      if (null != t)
        ...
        t))
          H.call(t, r) && !X.hasOwnProperty(r) && (i[r] = t[r]);
    ...
    function u(e, n, r) {
      return null == e
        ...
        : (function e(n, r, i, a) {
            ...
            if (l) return (i(a, n, "" === r ? "." + c(n, 0) : r), 1);
            if (((l = 0), (r = "" === r ? "." : r + ":"), Array.isArray(n)))
              ...
              ((u =
                null === n || "object" != typeof n
                  ? null
                  : "function" == typeof (u = (R && n[R]) || n["@@iterator"])
                    ? u
                    : null),
              "function" == typeof u)
            )
              for (n = u.call(n), s = 0; !(o = n.next()).done; )
                l += e((o = o.value), (u = r + c(o, s++)), i, a);
            else if ("object" === o)
              throw (
                (i = "" + n),
                Error(
    ...
    function b(e) {
      for (var t = v(ye); null !== t; ) {
        if (null === t.callback) y(ye);
        else {
          if (!(t.startTime <= e)) break;
          (y(ye), (t.sortIndex = t.expirationTime), m(ve, t));
        }
        t = v(ye);
      }
    }
    ...
    function k(e, t) {
      ((xe = !1), Se && ((Se = !1), ne()), (ke = !0));
      var n = we;
      try {
        for (
          b(t), be = v(ve);
          null !== be && (!(be.expirationTime > t) || (e && !re()));

        ) {
          var r = be.callback;
          if (null !== r) {
            ((be.callback = null), (we = be.priorityLevel));
            var i = r(be.expirationTime <= t);
            ((t = Z()),
              "function" == typeof i
                ? (be.callback = i)
                : be === v(ve) && y(ve),
    ...
    var S = "function" == typeof Symbol && Symbol.for,
      E = S ? Symbol.for("react.element") : 60103,
      T = S ? Symbol.for("react.portal") : 60106,
      C = S ? Symbol.for("react.fragment") : 60107,
      P = S ? Symbol.for("react.strict_mode") : 60108,
      I = S ? Symbol.for("react.profiler") : 60114,
      _ = S ? Symbol.for("react.provider") : 60109,
      z = S ? Symbol.for("react.context") : 60110,
      M = S ? Symbol.for("react.forward_ref") : 60112,
      L = S ? Symbol.for("react.suspense") : 60113,
      N = S ? Symbol.for("react.memo") : 60115,
      ...
      j = (function () {
        ...
        : function (e, t) {
            ...
            for (var n, r = Object(e), i = 1; i < arguments.length; i++) {
              ...
              for (var o in a) D.call(a, o) && (r[o] = a[o]);
              if (O) {
                n = O(a);
                for (var l = 0; l < n.length; l++)
                  F.call(a, n[l]) && (r[n[l]] = a[n[l]]);
              }
            }
            return r;
          },
    ...
    ((n.prototype.isReactComponent = {}),
      ...
      ((S = i.prototype = new r()).constructor = i),
      j(S, n.prototype),
    ...
    if ("undefined" == typeof window || "function" != typeof MessageChannel) {
      var q = null,
        ...
        ee = function (e) {
          null !== q ? setTimeout(ee, 0, e) : ((q = e), setTimeout(Y, 0));
        },
        te = function (e, t) {
          G = setTimeout(e, t);
        },
      ...
      if (
        ...
        "object" == typeof ie && "function" == typeof ie.now)
      )
        Z = function () {
          return ie.now();
        };
      ...
      ((pe.port1.onmessage = function () {
        if (null !== ce) {
          ...
          de = e + he;
          try {
            ce(!0, e) ? me.postMessage(null) : ((ue = !1), (ce = null));
          } catch (e) {
        ...
        (ee = function (e) {
          ((ce = e), ue || ((ue = !0), me.postMessage(null)));
        }),
        (te = function (e, t) {
          fe = oe(function () {
            e(Z());
    ...
    (j(
          ...
          unstable_scheduleCallback: function (e, t, n) {
            ...
            if ("object" == typeof n && null !== n) {
              ...
              ((i = "number" == typeof i && 0 < i ? r + i : r),
                (n = "number" == typeof n.timeout ? n.timeout : x(e)));
            } else ((n = x(e)), (i = r));
            return (
              (e = {
                id: ge++,
              ...
              i > r
                ? ((e.sortIndex = i),
                  ...
                  null === v(ve) &&
                    e === v(ye) &&
                    (Se ? ne() : (Se = !0), te(w, i - r)))
                : ((e.sortIndex = n), m(ve, e), xe || ke || ((xe = !0), ee(k))),
              e
            );
          },
          ...
          unstable_shouldYield: function () {
            ...
            return (
              (t !== be &&
                ...
                null !== t.callback &&
                t.startTime <= e &&
                t.expirationTime < be.expirationTime) ||
              re()
            );
          },
      ...
      (e.StrictMode = P),
      (e.Suspense = L),
      (e.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = pe),
      (e.cloneElement = function (e, n, r) {
        ...
        if (null != n) {
          if (
            (void 0 !== n.ref && ((o = n.ref), (l = V.current)),
          ...
          for (u in n)
            H.call(n, u) &&
              !X.hasOwnProperty(u) &&
              (i[u] = void 0 === n[u] && void 0 !== s ? s[u] : n[u]);
        }
  ...
  (function (e, t) {
    "object" == typeof exports && "undefined" != typeof module
      ...
      : System.registerDynamic("react-dom", ["react"], !1, function (e, n, r) {
          return t.call(n, n, e("react"));
        });
  })(0, function (e, t) {
    function n(e) {
      for (
    ...
    function r(e, t, r, i, a, o, l, s, u) {
      if (
        (function (e, t, n, r, i, a, o, l, s) {
          ((ti = !1), (ni = null), ei.apply(ai, arguments));
        }.apply(this, arguments),
        ti)
      ) {
        if (!ti) throw Error(n(198));
        var c = ni;
        ((ti = !1), (ni = null), ri || ((ri = !0), (ii = c)));
      }
    }
    function i(e, t, n) {
      var i = e.type || "unknown-event";
      ((e.currentTarget = si(n)), r(i, t, void 0, e), (e.currentTarget = null));
    }
    function a() {
      if (ui)
        for (var e in ci) {
          ...
          if (!fi[r]) {
            ...
            for (var i in ((fi[r] = t), (r = t.eventTypes))) {
              var a = void 0,
                l = r[i],
                s = t,
                u = i;
              if (hi.hasOwnProperty(u)) throw Error(n(99, u));
              hi[u] = l;
              var c = l.phasedRegistrationNames;
              if (c) {
                for (a in c) c.hasOwnProperty(a) && o(c[a], s, u);
                a = !0;
              } else
                l.registrationName
                  ? (o(l.registrationName, s, u), (a = !0))
                  : (a = !1);
              if (!a) throw Error(n(98, i, e));
            }
          }
        }
    }
    function o(e, t, r) {
      if (di[e]) throw Error(n(100, e));
      ((di[e] = t), (pi[e] = t.eventTypes[r].dependencies));
    }
    function l(e) {
      var t,
        r = !1;
      for (t in e)
        if (e.hasOwnProperty(t)) {
          var i = e[t];
          if (!ci.hasOwnProperty(t) || ci[t] !== i) {
            if (ci[t]) throw Error(n(102, t));
            ((ci[t] = i), (r = !0));
          }
        }
      r && a();
    ...
    function s(e) {
      if ((e = li(e))) {
        ...
        var t = e.stateNode;
        t && ((t = oi(t)), yi(e.stateNode, e.type, t));
      }
    }
    function u(e) {
    ...
    function c() {
      if (gi) {
        var e = gi,
          t = bi;
        if (((bi = gi = null), s(e), t)) for (e = 0; e < t.length; e++) s(t[e]);
      }
    }
    function f() {
      (null === gi && null === bi) || (xi(), c());
    }
    function h(e, t, n) {
      if (Ti) return e(t, n);
      Ti = !0;
    ...
    function p(e, t, n, r) {
      var i = Vi.hasOwnProperty(t) ? Vi[t] : null;
      (null !== i
        ? 0 === i.type
        : !r &&
          2 < t.length &&
    ...
    function m(e) {
      return null === e || "object" != typeof e
        ? null
        : "function" == typeof (e = (fa && e[fa]) || e["@@iterator"])
          ? e
          : null;
    }
    function v(e) {
    ...
    function T(e, t) {
      ...
      (t.hasOwnProperty("value")
        ? P(e, t.type, n)
        : t.hasOwnProperty("defaultValue") && P(e, t.type, g(t.defaultValue)),
        null == t.checked &&
    ...
    function D(e) {
      ...
      var t,
        n = pa[e];
      for (t in n) if (n.hasOwnProperty(t) && t in va) return (ma[e] = n[t]);
      return e;
    }
    function F(e) {
      var t = xa.get(e);
      return (void 0 === t && ((t = new Map()), xa.set(e, t)), t);
    }
    function j(e) {
      var t = e,
        n = e;
    ...
    function W(e) {
      if (
        !(e = (function (e) {
          var t = e.alternate;
          if (!t) {
            if (null === (t = j(e))) throw Error(n(188));
            return t !== e ? null : e;
          }
          for (var r = e, i = t; ; ) {
            var a = r.return;
    ...
    function X(e) {
      if ((null !== e && (Sa = V(Sa, e)), (e = Sa), (Sa = null), e)) {
        if ((H(e, Ea), Sa)) throw Error(n(95));
        if (ri) throw ((e = ii), (ri = !1), (ii = null), e);
      }
    }
    function Q(e) {
      return (
    ...
    function G(e) {
      ...
      do {
        ...
        if (!r) break;
        ((5 !== (t = n.tag) && 6 !== t) || e.ancestors.push(n), (n = Pe(r)));
      } while (n);
      for (n = 0; n < e.ancestors.length; n++) {
        ...
        0 === n && (o |= 64);
        for (var l = null, s = 0; s < fi.length; s++) {
          var u = fi[s];
          u && (u = u.extractEvents(r, t, a, i, o)) && (l = V(l, u));
        }
        X(l);
      }
    }
    ...
    function ne(e) {
      ...
      if (null !== t) {
        var n = Ie(t);
        return (null !== n && tu(n), (e.blockedOn = t), !1);
      }
      return !0;
    }
    function re(e, t, n) {
    ...
    function ie() {
      for (Ca = !1; 0 < Pa.length; ) {
        var e = Pa[0];
        if (null !== e.blockedOn) {
          null !== (e = Ie(e.blockedOn)) && eu(e);
          break;
        }
        var t = fe(
          e.topLevelType,
        ...
        null !== t ? (e.blockedOn = t) : Pa.shift();
      }
      (null !== Ia && ne(Ia) && (Ia = null),
        null !== _a && ne(_a) && (_a = null),
        null !== za && ne(za) && (za = null),
        Ma.forEach(re),
        La.forEach(re));
    }
    function ae(e, t) {
      e.blockedOn === t &&
        ((e.blockedOn = null), Ca || ((Ca = !0), _i(Oi, ie)));
    }
    function oe(e) {
      if (0 < Pa.length) {
        ae(Pa[0], e);
      ...
      for (
        ...
        (n = Na[t]).blockedOn === e && (n.blockedOn = null);
      for (; 0 < Na.length && null === (t = Na[0]).blockedOn; )
        (te(t), null === t.blockedOn && Na.shift());
    }
    function le(e, t) {
    ...
    function ce(e, t, n, r) {
      if (Wa)
        if (0 < Pa.length && -1 < Aa.indexOf(e))
          ((e = J(null, e, t, n, r)), Pa.push(e));
        else {
          var i = fe(e, t, n, r);
          if (null === i) Z(e, r);
          else if (-1 < Aa.indexOf(e)) ((e = J(i, e, t, n, r)), Pa.push(e));
          else if (
            !(function (e, t, n, r, i) {
              switch (t) {
                case "focus":
                  return ((Ia = ee(Ia, e, t, n, r, i)), !0);
                case "dragenter":
                  return ((_a = ee(_a, e, t, n, r, i)), !0);
                case "mouseover":
                  return ((za = ee(za, e, t, n, r, i)), !0);
                case "pointerover":
                  var a = i.pointerId;
                  return (Ma.set(a, ee(Ma.get(a) || null, e, t, n, r, i)), !0);
                case "gotpointercapture":
                  return (
                    (a = i.pointerId),
                    La.set(a, ee(La.get(a) || null, e, t, n, r, i)),
                    !0
                  );
              }
              return !1;
    ...
    function pe(e, t) {
      if (t) {
        if (Xa[e] && (null != t.children || null != t.dangerouslySetInnerHTML))
          throw Error(n(137, e, ""));
    ...
    function ve(e, t) {
      ...
      t = pi[t];
      for (var r = 0; r < t.length; r++) Y(t[r], e, n);
    }
    function ye() {}
    function ge(e) {
      if (
    ...
    function Ne(e, t, n) {
      (t = Le(e, n.dispatchConfig.phasedRegistrationNames[t])) &&
    ...
    function Ae(e) {
      if (e && e.dispatchConfig.phasedRegistrationNames) {
        ...
        for (t = n.length; 0 < t--; ) Ne(n[t], "captured", e);
        for (t = 0; t < n.length; t++) Ne(n[t], "bubbled", e);
      }
    }
    function Re(e, t, n) {
      e &&
        ...
        (t = Le(e, n.dispatchConfig.registrationName)) &&
        ((n._dispatchListeners = V(n._dispatchListeners, t)),
        (n._dispatchInstances = V(n._dispatchInstances, e)));
    }
    function Oe(e) {
      e && e.dispatchConfig.registrationName && Re(e._targetInst, null, e);
    }
    function De(e) {
      H(e, Ae);
    }
    ...
    function He(e) {
      ((e.eventPool = []), (e.getPooled = We), (e.release = Ve));
    }
    function Xe(e, t) {
      switch (e) {
        case "keyup":
          return -1 !== uo.indexOf(t.keyCode);
        case "keydown":
    ...
    function Ke(e, t, n) {
      return (
        ((e = Be.getPooled(ko.change, e, t, n)).type = "change"),
        u(n),
        De(e),
        e
      );
    ...
    function Je() {
      xo && (xo.detachEvent("onpropertychange", Ze), (So = xo = null));
    }
    function Ze(e) {
      if ("value" === e.propertyName && Ge(So))
        if (((e = Ke(So, e, Q(e))), Ei)) X(e);
        else {
          Ei = !0;
          try {
            wi(qe, e);
    ...
    function et(e, t, n) {
      "focus" === e
        ? (Je(), (So = n), (xo = t).attachEvent("onpropertychange", Ze))
        : "blur" === e && Je();
    }
    function tt(e, t) {
    ...
    function ot(e, t) {
      ...
      for (r = 0; r < n.length; r++)
        if (!Do.call(t, n[r]) || !Oo(e[n[r]], t[n[r]])) return !1;
      return !0;
    }
    function lt(e, t) {
      var n =
        t.window === t ? t.document : 9 === t.nodeType ? t : t.ownerDocument;
      return Vo || null == Uo || Uo !== ge(n)
        ? null
        : ("selectionStart" in (n = Uo) && xe(n)
          ...
          Wo && ot(Wo, n)
            ? null
            : ((Wo = n),
              ((e = Be.getPooled(jo.select, Bo, e, t)).type = "select"),
              (e.target = Uo),
              De(e),
              e));
    }
    ...
    function dt(e, t, r) {
      if (al.current !== il) throw Error(n(168));
      (ct(al, t), ct(ol, r));
    }
    function pt(e, t, r) {
      var i = e.stateNode;
      ...
      for (var a in (i = i.getChildContext()))
        if (!(a in e)) throw Error(n(108, v(t) || "Unknown", a));
      return vi({}, r, {}, i);
    }
    function mt(e) {
      return (
    ...
    function bt(e, t) {
      return ((e = gt(e)), sl(e, t));
    }
    function wt(e, t, n) {
      return ((e = gt(e)), ul(e, t, n));
    }
    function kt(e) {
      return (null === wl ? ((wl = [e]), (kl = ul(hl, St))) : wl.push(e), yl);
    }
    function xt() {
      if (null !== kl) {
        var e = kl;
    ...
    function St() {
      if (!xl && null !== wl) {
        ...
        try {
          ...
          throw (null !== wl && (wl = wl.slice(e + 1)), ul(hl, xt), t);
        } finally {
          xl = !1;
        }
      }
    ...
    function Tt(e, t) {
      if (e && e.defaultProps)
        for (var n in ((t = vi({}, t)), (e = e.defaultProps)))
          void 0 === t[n] && (t[n] = e[n]);
      return t;
    }
    function Ct() {
    ...
    function Pt(e) {
      var t = Tl.current;
      (ut(Tl), (e.type._context._currentValue = t));
    }
    function It(e, t) {
      for (; null !== e; ) {
        var n = e.alternate;
    ...
    function _t(e, t) {
      ((Cl = e),
        ...
        null !== (e = e.dependencies) &&
          null !== e.firstContext &&
          (e.expirationTime >= t && (is = !0), (e.firstContext = null)));
    }
    function zt(e, t) {
      if (Il !== e && !1 !== t && 0 !== t)
        if (
        ...
        if (null !== l)
          for (var d = l; ; ) {
            if ((o = d.expirationTime) < r) {
              ...
              null !== d.callback &&
                ((e.effectTag |= 32),
                null === (o = i.effects) ? (i.effects = [d]) : o.push(d));
            }
      ...
      if (((e = t.effects), (t.effects = null), null !== e))
        for (t = 0; t < e.length; t++) {
          var i = e[t],
            a = i.callback;
          if (null !== a) {
            if (((i.callback = null), (i = a), (a = r), "function" != typeof i))
              throw Error(n(191, i));
            i.call(a);
          }
        }
    ...
    function Ft(e, t, n, r) {
      ((n = null == (n = n(r, (t = e.memoizedState))) ? t : vi({}, t, n)),
        (e.memoizedState = n),
    ...
    function Ut(e, t, n) {
      ...
      return (
        "object" == typeof a && null !== a
          ? (a = zt(a))
          : ((i = ht(t) ? ll : al.current),
            (a = (r = null != (r = t.contextTypes)) ? ft(e, i) : il)),
        (t = new t(n, a)),
        (e.memoizedState =
    ...
    function Wt(e, t, n, r) {
      var i = e.stateNode;
      ((i.props = n), (i.state = e.memoizedState), (i.refs = Nl), Mt(e));
      var a = t.contextType;
      ("object" == typeof a && null !== a
        ? (i.context = zt(a))
        : ((a = ht(t) ? ll : al.current), (i.context = ft(e, a))),
        Ot(e, n, i, r),
        (i.state = e.memoizedState),
        "function" == typeof (a = t.getDerivedStateFromProps) &&
          (Ft(e, t, a, n), (i.state = e.memoizedState)),
    ...
    function Xt(e) {
      ...
      function a(e, t) {
        return (((e = Or(e, t)).index = 0), (e.sibling = null), e);
      }
      function o(t, n, r) {
        return (
          (t.index = r),
      ...
      function u(e, t, n, r) {
        return null !== t && t.elementType === n.type
          ? (((r = a(t, n.props)).ref = Vt(e, t, n)), (r.return = e), r)
          : (((r = Dr(n.type, n.key, n.props, null, e.mode, r)).ref = Vt(
              e,
              t,
              n,
            )),
      ...
      function h(e, t, n) {
        ...
        if ("object" == typeof t && null !== t) {
          switch (t.$$typeof) {
            case Yi:
              return (
                ((n = Dr(t.type, t.key, t.props, null, e.mode, n)).ref = Vt(
                  e,
                  null,
                  t,
                )),
      ...
      function d(e, t, n, r) {
        ...
        if ("object" == typeof n && null !== n) {
          ...
          if (Rl(n) || m(n)) return null !== i ? null : f(e, t, n, r, null);
          Ht(e, n);
        }
        return null;
      }
      function p(e, t, n, r, i) {
        ...
        if ("object" == typeof r && null !== r) {
          ...
          if (Rl(r) || m(r)) return f(t, (e = e.get(n) || null), r, i, null);
          Ht(t, r);
        }
        return null;
      }
      function v(n, a, l, s) {
        ...
        for (f = i(n, f); m < l.length; m++)
          null !== (v = p(f, n, m, l[m], s)) &&
      ...
      function y(a, l, s, u) {
        ...
        for (
          var f = (c = null), v = l, y = (l = 0), g = null, b = s.next();
          null !== v && !b.done;
          y++, b = s.next()
        ) {
          v.index > y ? ((g = v), (v = null)) : (g = v.sibling);
          var w = d(a, v, b.value, u);
          if (null === w) {
            null === v && (v = g);
            break;
          }
          (e && v && null === w.alternate && t(a, v),
            (l = o(w, l, y)),
            null === f ? (c = w) : (f.sibling = w),
            (f = w),
            (v = g));
        }
        if (b.done) return (r(a, v), c);
        if (null === v) {
          for (; !b.done; y++, b = s.next())
            null !== (b = h(a, b.value, u)) &&
              ((l = o(b, l, y)),
              null === f ? (c = b) : (f.sibling = b),
              (f = b));
          return c;
        }
        for (v = i(a, v); !b.done; y++, b = s.next())
          null !== (b = p(v, a, y, b.value, u)) &&
      ...
      return function (e, i, o, s) {
        var u =
          "object" == typeof o && null !== o && o.type === Zi && null === o.key;
          ...
          switch (o.$$typeof) {
            case Yi:
              e: {
                  ...
                  if (u.key === c) {
                    switch (u.tag) {
                      case 7:
                        if (o.type === Zi) {
                          (r(e, u.sibling),
                            ((i = a(u, o.props.children)).return = e),
                            (e = i));
                          break e;
                        }
                        break;
                ...
                o.type === Zi
                  ? (((i = Fr(o.props.children, e.mode, s, o.key)).return = e),
                    (e = i))
                  : (((s = Dr(o.type, o.key, o.props, null, e.mode, s)).ref =
                      Vt(e, i, o)),
                    (s.return = e),
                    (e = s));
              }
        ...
        if ("string" == typeof o || "number" == typeof o)
          return (
            (o = "" + o),
            null !== i && 6 === i.tag
              ? (r(e, i.sibling), ((i = a(i, o)).return = e), (e = i))
              : (r(e, i), ((i = jr(o, e.mode, s)).return = e), (e = i)),
            l(e)
          );
        if (Rl(o)) return v(e, i, o, s);
        if (m(o)) return y(e, i, o, s);
        if ((c && Ht(e, o), void 0 === o && !u))
          switch (e.tag) {
            case 1:
            case 0:
              throw (
    ...
    function $t(e, t) {
      switch ((ct(Bl, t), ct(Ul, e), ct(jl, Fl), (e = t.nodeType))) {
        case 9:
        case 11:
    ...
    function Yt(e) {
      for (var t = e; null !== t; ) {
        if (13 === t.tag) {
          ...
          if (
            null !== n &&
            (null === (n = n.dehydrated) || n.data === Ka || n.data === qa)
          )
            return t;
    ...
    function tn(e, t, r, i, a, o) {
      if (
        ...
        (t.updateQueue = null),
        (t.expirationTime = 0),
        (Vl.current = null === e || null === e.memoizedState ? Yl : Jl),
        (e = r(i, a)),
        t.expirationTime === Xl)
      ) {
        o = 0;
        do {
          if (((t.expirationTime = 0), !(25 > o))) throw Error(n(301));
          ((o += 1),
            (Kl = $l = null),
            (t.updateQueue = null),
            (Vl.current = Zl),
    ...
    function on(e, t, r) {
      if (null === (r = (t = rn()).queue)) throw Error(n(311));
        ...
        do {
          ...
          if (c < Xl) {
            ...
            (null === s ? ((l = s = f), (o = i)) : (s = s.next = f),
              c > Ql.expirationTime && ((Ql.expirationTime = c), kr(c)));
          } else
            (null !== s &&
              (s = s.next =
                {
              ...
              wr(c, u.suspenseConfig),
              (i = u.eagerReducer === e ? u.eagerState : e(i, u.action)));
          u = u.next;
        } while (null !== u && u !== a);
        (null === s ? (o = i) : (s.next = l),
          Oo(i, t.memoizedState) || (is = !0),
          (t.memoizedState = i),
          (t.baseState = o),
          (t.baseQueue = s),
    ...
    function fn(e, t, n, r) {
      var i = nn();
      ((Ql.effectTag |= e),
        (i.memoizedState = un(1 | t, n, void 0, void 0 === r ? null : r)));
    }
    function hn(e, t, n, r) {
      var i = rn();
      r = void 0 === r ? null : r;
      ...
      if (null !== $l) {
        ...
        if (((a = o.destroy), null !== r && en(r, o.deps)))
          return void un(t, n, a, r);
      }
      ((Ql.effectTag |= e), (i.memoizedState = un(1 | t, n, a, r)));
    }
    function dn(e, t) {
      return fn(516, 4, e, t);
    }
    ...
    function xn(e, t, n) {
      var r = yt();
      (bt(98 > r ? 98 : r, function () {
        e(!0);
      }),
        bt(97 < r ? 97 : r, function () {
          var r = Hl.suspense;
          Hl.suspense = void 0 === t ? null : t;
          try {
            (e(!1), n());
          } finally {
            Hl.suspense = r;
    ...
    function Sn(e, t, n) {
      ...
      if (
        ...
        ((ql = !0), (i.expirationTime = Xl), (Ql.expirationTime = Xl));
      else {
        if (
          0 === e.expirationTime &&
          ...
          try {
            var o = t.lastRenderedState,
              l = a(o, n);
            if (((i.eagerReducer = a), (i.eagerState = l), Oo(l, o))) return;
          } catch (e) {}
        qs(e, r);
      }
    }
    ...
    function Cn(e) {
      if (ns) {
        ...
        if (t) {
          ...
          ((es = e), (ts = Te(t.firstChild)));
        } else ((e.effectTag = (-1025 & e.effectTag) | 2), (ns = !1), (es = e));
      }
    }
    function Pn(e) {
      for (
    ...
    function In(e) {
      if (e !== es) return !1;
      if (!ns) return (Pn(e), (ns = !0), !1);
      var t = e.type;
      if (
        5 !== e.tag ||
        ("head" !== t && "body" !== t && !Ee(t, e.memoizedProps))
      )
        for (t = ts; t; ) (En(e, t), (t = Te(t.nextSibling)));
      if ((Pn(e), 13 === e.tag)) {
          ...
          for (e = e.nextSibling, t = 0; e; ) {
            if (8 === e.nodeType) {
              ...
              if (r === $a) {
                ...
                t--;
              } else (r !== Qa && r !== qa && r !== Ka) || t++;
            }
            e = e.nextSibling;
          }
          ts = null;
        }
      } else ts = es ? Te(e.stateNode.nextSibling) : null;
      return !0;
    }
    function _n() {
      ((ts = es = null), (ns = !1));
    ...
    function zn(e, t, n, r) {
      t.child = null === e ? Dl(t, null, n, r) : Ol(t, e.child, n, r);
    }
    ...
    function Ln(e, t, n, r, i, a) {
      if (null === e) {
        ...
        return "function" != typeof o ||
          ...
          ? (((e = Dr(n.type, null, r, null, t.mode, a)).ref = t.ref),
            (e.return = t),
            (t.child = e))
          : ((t.tag = 15), (t.type = o), Nn(e, t, o, r, i, a));
      }
      return (
        (o = e.child),
        i < a &&
        ((i = o.memoizedProps),
        (n = null !== (n = n.compare) ? n : ot)(i, r) && e.ref === t.ref)
          ? Vn(e, t, a)
          : ((t.effectTag |= 1),
            ((e = Or(o, r)).ref = t.ref),
            (e.return = t),
    ...
    function Nn(e, t, n, r, i, a) {
      return null !== e &&
        ...
        e.ref === t.ref &&
        ((is = !1), i < a)
        ? ((t.expirationTime = e.expirationTime), Vn(e, t, a))
        : Rn(e, t, n, r, a);
    }
    function An(e, t) {
      var n = t.ref;
    ...
    function On(e, t, n, r, i) {
      ...
      if ((_t(t, i), null === t.stateNode))
        ...
        ((o.state = h),
          Ot(t, r, o, i),
          (s = t.memoizedState),
          l !== r || h !== s || ol.current || Ml
            ? ("function" == typeof c &&
                (Ft(t, n, c, r), (s = t.memoizedState)),
              (l = Ml || jt(t, n, l, r, h, s, u))
                ? (f ||
        ...
        ((o = t.stateNode),
          Lt(e, t),
          (l = t.memoizedProps),
          (o.props = t.type === t.elementType ? l : Tt(t.type, l)),
          (s = o.context),
          ...
          Ot(t, r, o, i),
          (h = t.memoizedState),
          l !== r || s !== h || ol.current || Ml
            ? ("function" == typeof c &&
                (Ft(t, n, c, r), (h = t.memoizedState)),
              (c = Ml || jt(t, n, l, r, s, h, u))
                ? (f ||
            ...
            : ("function" != typeof o.componentDidUpdate ||
              ...
              "function" != typeof o.getSnapshotBeforeUpdate ||
                ...
                (t.effectTag |= 256),
              (r = !1)));
      return Dn(e, t, n, r, a, i);
    }
    function Dn(e, t, n, r, i, a) {
      An(e, t);
      var o = 0 != (64 & t.effectTag);
      if (!r && !o) return (i && vt(t, n, !1), Vn(e, t, a));
      ...
      return (
        (t.effectTag |= 1),
        null !== e && o
          ? ((t.child = Ol(t, e.child, null, a)), (t.child = Ol(t, null, l, a)))
          : zn(e, t, l, a),
    ...
    function Fn(e) {
      var t = e.stateNode;
      (t.pendingContext
        ? dt(0, t.pendingContext, t.pendingContext !== t.context)
        : t.context && dt(0, t.context, !1),
        $t(e, t.containerInfo));
    }
    function jn(e, t, n) {
      var r,
      ...
      if (
        ...
        if ((void 0 !== a.fallback && Cn(t), l)) {
          if (
            ((l = a.fallback),
            ((a = Fr(null, i, 0, null)).return = t),
            0 == (2 & t.mode))
          )
            for (
      ...
      if (null !== e.memoizedState) {
        if (((i = (e = e.child).sibling), l)) {
          if (
            ((a = a.fallback),
            ((n = Or(e, e.pendingProps)).return = t),
            0 == (2 & t.mode) &&
      ...
      return ((t.memoizedState = null), (t.child = Ol(t, e, a.children, n)));
    }
    function Un(e, t) {
    ...
    function Wn(e, t, n) {
      var r = t.pendingProps,
        i = r.revealOrder,
        a = r.tail;
      if ((zn(e, t, r.children, n), 0 != (2 & (r = Wl.current))))
        ((r = (1 & r) | 2), (t.effectTag |= 64));
      else {
        if (null !== e && 0 != (64 & e.effectTag))
          e: for (e = t.child; null !== e; ) {
            if (13 === e.tag) null !== e.memoizedState && Un(e, n);
            else if (19 === e.tag) Un(e, n);
      ...
      if ((ct(Wl, r), 0 == (2 & t.mode))) t.memoizedState = null;
      else
        switch (i) {
          case "forwards":
            for (n = t.child, i = null; null !== n; )
              (null !== (e = n.alternate) && null === Yt(e) && (i = n),
                (n = n.sibling));
            (null === (n = i)
              ? ((i = t.child), (t.child = null))
              : ((i = n.sibling), (n.sibling = null)),
              Bn(t, !1, i, n, a, t.lastEffect));
            break;
          case "backwards":
            for (n = null, i = t.child, t.child = null; null !== i; ) {
              if (null !== (e = i.alternate) && null === Yt(e)) {
                t.child = i;
                break;
              }
              ((e = i.sibling), (i.sibling = n), (n = i), (i = e));
            }
            Bn(t, !0, n, null, a, t.lastEffect);
            break;
          case "together":
            Bn(t, !1, null, null, void 0, t.lastEffect);
            break;
          default:
            t.memoizedState = null;
        }
    ...
    function Vn(e, t, r) {
      ...
      if ((0 !== i && kr(i), t.childExpirationTime < r)) return null;
      if (null !== e && t.child !== e.child) throw Error(n(153));
      if (null !== t.child) {
        for (
          r = Or((e = t.child), e.pendingProps), t.child = r, r.return = t;
          null !== e.sibling;

        )
          ((e = e.sibling),
            ((r = r.sibling = Or(e, e.pendingProps)).return = t));
        r.sibling = null;
      }
      return t.child;
    }
    ...
    function Xn(e, t, r) {
      ...
      switch (t.tag) {
        ...
        case 14:
          return null;
        case 1:
          return (ht(t.type) && (ut(ol), ut(al)), null);
        case 3:
          return (
            Kt(),
            ut(ol),
            ...
            (null !== e && null !== e.child) || !In(t) || (t.effectTag |= 4),
            ls(t),
            null
          );
        case 5:
          (Gt(t), (r = Qt(Bl.current)));
          var a = t.type;
          if (null !== e && null != t.stateNode)
            (ss(e, t, a, i, r), e.ref !== t.ref && (t.effectTag |= 128));
          else {
            if (!i) {
              if (null === t.stateNode) throw Error(n(166));
              return null;
            }
            if (((e = Qt(jl.current)), In(t))) {
              ((i = t.stateNode), (a = t.type));
              var o = t.memoizedProps;
              switch (((i[to] = t), (i[no] = o), a)) {
                case "iframe":
                case "object":
                case "embed":
                  se("load", i);
                ...
                case "video":
                case "audio":
                  for (e = 0; e < ka.length; e++) se(ka[e], i);
                  break;
                case "source":
                  se("error", i);
                  break;
                ...
                case "link":
                  ...
                  break;
                case "form":
                  (se("reset", i), se("submit", i));
                  break;
                case "details":
                  se("toggle", i);
                  break;
                case "input":
                  (S(i, o), se("invalid", i), ve(r, "onChange"));
                  break;
                case "select":
                  ...
                  break;
                case "textarea":
                  (M(i, o), se("invalid", i), ve(r, "onChange"));
              }
              for (var l in (pe(a, o), (e = null), o))
                if (o.hasOwnProperty(l)) {
                  var s = o[l];
                  "children" === l
                    ? "string" == typeof s
                      ? i.textContent !== s && (e = ["children", s])
                      : "number" == typeof s &&
                        i.textContent !== "" + s &&
                        (e = ["children", "" + s])
                    : di.hasOwnProperty(l) && null != s && ve(r, l);
                }
              switch (a) {
                case "input":
                  (w(i), C(i, o, !0));
                ...
                case "option":
                  break;
                default:
                  "function" == typeof o.onClick && (i.onclick = ye);
              }
              ((r = e), (t.updateQueue = r), null !== r && (t.effectTag |= 4));
            } else {
              switch (
                ((l = 9 === r.nodeType ? r : r.ownerDocument),
                "http://www.w3.org/1999/xhtml" === e && (e = A(a)),
                ...
                case "video":
                case "audio":
                  for (s = 0; s < ka.length; s++) se(ka[s], e);
                  s = i;
                  break;
                case "source":
                  (se("error", e), (s = i));
                ...
                case "link":
                  ...
                  break;
                case "form":
                  (se("reset", e), se("submit", e), (s = i));
                  break;
                case "details":
                  (se("toggle", e), (s = i));
                  break;
                case "input":
                  (S(e, i), (s = x(e, i)), se("invalid", e), ve(r, "onChange"));
                  break;
                case "option":
                  s = I(e, i);
                  break;
                case "select":
                  ...
                  break;
                case "textarea":
                  (M(e, i), (s = z(e, i)), se("invalid", e), ve(r, "onChange"));
                  break;
                default:
                  s = i;
              }
                ...
                if (u.hasOwnProperty(o)) {
                  ...
                  "style" === o
                    ...
                    : "dangerouslySetInnerHTML" === o
                      ? null != (c = c ? c.__html : void 0) && ha(e, c)
                      : "children" === o
                        ? "string" == typeof c
                          ? ("textarea" !== a || "" !== c) && da(e, c)
                          : "number" == typeof c && da(e, "" + c)
              ...
              switch (a) {
                ...
                case "textarea":
                  ...
                  break;
                case "option":
                  null != i.value && e.setAttribute("value", "" + g(i.value));
                  break;
                case "select":
                  ((e.multiple = !!i.multiple),
                    null != (r = i.value)
                      ? _(e, !!i.multiple, r, !1)
                      : null != i.defaultValue &&
                        _(e, !!i.multiple, i.defaultValue, !0));
                  break;
                default:
                  "function" == typeof s.onClick && (e.onclick = ye);
              }
              Se(a, i) && (t.effectTag |= 4);
            }
            null !== t.ref && (t.effectTag |= 128);
          }
          return null;
        case 6:
          if (e && null != t.stateNode) us(e, t, e.memoizedProps, i);
          else {
          ...
          return (
            ...
            0 != (64 & t.effectTag)
              ...
              : ((r = null !== i),
                (i = !1),
                null === e
                  ? void 0 !== t.memoizedProps.fallback && In(t)
                ...
                r &&
                  ...
                  0 != (1 & Wl.current)
                    ? _s === bs && (_s = xs)
                    : ((_s !== bs && _s !== xs) || (_s = Ss),
                      0 !== As && null !== Cs && (Vr(Cs, Is), Hr(Cs, As)))),
                (r || i) && (t.effectTag |= 4),
                null)
          );
        case 4:
        ...
        case 17:
          return (ht(t.type) && (ut(ol), ut(al)), null);
        case 19:
          if ((ut(Wl), null === (i = t.memoizedState))) return null;
          if (((a = 0 != (64 & t.effectTag)), null === (o = i.rendering))) {
            if (a) Hn(i, !1);
            else if (_s !== bs || (null !== e && 0 != (64 & e.effectTag)))
                ...
                if (null !== (e = Yt(o))) {
                  for (
                    ...
                    ((o = r),
                      ...
                      (i = i.sibling));
                  return (ct(Wl, (1 & Wl.current) | 2), t.child);
                }
                o = o.sibling;
              }
          } else {
            if (!a)
              if (null !== (e = Yt(o))) {
                ...
                2 * El() - i.renderingStartTime > i.tailExpiration &&
                  1 < r &&
                  ((t.effectTag |= 64),
                  (a = !0),
                  Hn(i, !1),
            ...
            i.isBackwards
              ...
              : (null !== (r = i.last) ? (r.sibling = o) : (t.child = o),
                (i.last = o));
          }
          return null !== i.tail
            ? (0 === i.tailExpiration && (i.tailExpiration = El() + 500),
              (r = i.tail),
              (i.rendering = r),
              (i.tail = r.sibling),
              (i.lastEffect = t.lastEffect),
              (i.renderingStartTime = El()),
              (r.sibling = null),
              (t = Wl.current),
              ct(Wl, a ? (1 & t) | 2 : 1 & t),
              r)
    ...
    function Qn(e, t) {
      switch (e.tag) {
        case 1:
          return (
            ht(e.type) && (ut(ol), ut(al)),
            4096 & (t = e.effectTag)
              ? ((e.effectTag = (-4097 & t) | 64), e)
              : null
          );
        case 3:
          if ((Kt(), ut(ol), ut(al), 0 != (64 & (t = e.effectTag))))
            throw Error(n(285));
        ...
        case 1:
          if (256 & t.effectTag && null !== e) {
            ...
            ((t = (e = t.stateNode).getSnapshotBeforeUpdate(
              t.elementType === t.type ? r : Tt(t.type, r),
              i,
            )),
      ...
      switch (r.tag) {
              ...
              (null === t
                ...
                : ((i =
                    r.elementType === r.type
                      ? t.memoizedProps
                      : Tt(r.type, t.memoizedProps)),
                  e.componentDidUpdate(
                    i,
                    t.memoizedState,
                    e.__reactInternalSnapshotBeforeUpdate,
                  ))),
            void (null !== (t = r.updateQueue) && Dt(r, t, e))
          );
        case 3:
        ...
        case 13:
          return void (
            ...
            null !== r &&
              ((r = r.memoizedState),
              null !== r && ((r = r.dehydrated), null !== r && oe(r))))
          );
        case 19:
        case 17:
        case 20:
    ...
    function rr(e) {
      ...
      16 & r.effectTag && (da(t, ""), (r.effectTag &= -17));
      e: t: for (r = e; ; ) {
        for (; null === r.sibling; ) {
          if (null === r.return || nr(r.return)) {
            r = null;
            break e;
          }
          r = r.return;
              ...
              ((t = a ? t.stateNode : t.stateNode.instance),
                n
                  ...
                  : (8 === r.nodeType
                    ...
                    null != r || null !== n.onclick || (n.onclick = ye)));
    ...
    function ar(e, t) {
      switch (t.tag) {
                ...
                case "select":
                  ((t = r._wrapperState.wasMultiple),
                    ...
                    null != (e = i.value)
                      ...
                      : t !== !!i.multiple &&
                        (null != i.defaultValue
                          ? _(r, !!i.multiple, i.defaultValue, !0)
                          : _(r, !!i.multiple, i.multiple ? [] : "", !1)));
              }
            }
          }
          return;
        ...
        case 3:
          return void (
            (t = t.stateNode).hydrate && ((t.hydrate = !1), oe(t.containerInfo))
          );
        case 12:
          return;
        case 13:
    ...
    function lr(e, t, n) {
      (((n = Nt(n, null)).tag = 3), (n.payload = { element: null }));
      var r = t.value;
      return (
        (n.callback = function () {
          (js || ((js = !0), (Us = r)), Kn(e, t));
    ...
    function sr(e, t, n) {
      ...
      return (
        null !== a &&
          ...
          (n.callback = function () {
            "function" != typeof r &&
              (null === Bs ? (Bs = new Set([this])) : Bs.add(this), Kn(e, t));
            var n = t.stack;
    ...
    function ur() {
      return (Ts & (ys | gs)) !== ms
        ...
        : 0 !== Ks
          ? Ks
          : (Ks = 1073741821 - ((El() / 10) | 0));
    }
    function cr(e, t, r) {
      if (0 == (2 & (t = t.mode))) return 1073741823;
      var i = yt();
      if (0 == (4 & t)) return 99 === i ? 1073741823 : 1073741822;
      if ((Ts & ys) !== ms) return Is;
      if (null !== r) e = Et(e, 0 | r.timeoutMs || 5e3, 250);
      else
        switch (i) {
          case 99:
            e = 1073741823;
    ...
    function fr(e, t) {
      ...
      return (
        null !== i && (Cs === i && (kr(t), _s === Ss && Vr(i, Is)), Hr(i, t)),
        i
      );
    }
    function hr(e) {
      ...
      if (0 !== t) return t;
      if (!Wr(e, (t = e.firstPendingTime))) return t;
    ...
    function dr(e) {
      if (0 !== e.lastExpiredTime)
        ((e.callbackExpirationTime = 1073741823),
          ...
          (e.callbackNode = kt(pr.bind(null, e))));
      else {
        var t = hr(e),
          r = e.callbackNode;
        if (0 === t)
          ...
          if (
            ...
            if (e.callbackExpirationTime === t && a >= i) return;
            r !== yl && cl(r);
          }
            ...
            (t =
              1073741823 === t
                ...
                : wt(
                    ...
                    function e(t, r) {
                      Ks = 0;
                      if (r) return ((r = ur()), Xr(t, r), dr(t), null);
                      var i = hr(t);
                      if (0 !== i) {
                        if (((r = t.callbackNode), (Ts & (ys | gs)) !== ms))
                          throw Error(n(327));
                        if (
                          (_r(),
                          (t === Cs && i === Is) || yr(t, i),
                          ...
                          if ((Ct(), (Ts = a), (ds.current = o), _s === ws))
                            throw ((r = zs), yr(t, i), Vr(t, i), dr(t), r);
                          if (null === Ps)
                            switch (
                              ...
                              case xs:
                                if (
                                  ...
                                  i === a && (t.nextKnownPendingLevel = Cr(o)),
                                  1073741823 === Ms &&
                                    10 < (o = Os + Ds - El()))
                                ) {
                                  if (Rs) {
                                    ...
                                    if (0 === l || l >= i) {
                                      ((t.lastPingedTime = i), yr(t, i));
                                      break;
                                    }
                                  }
                                  if (0 !== (l = hr(t)) && l !== i) break;
                                  if (0 !== a && a !== i) {
                                    t.lastPingedTime = a;
                                    break;
                                  }
                                  t.timeoutHandle = Ja(Pr.bind(null, t), o);
                                  break;
                                }
                                Pr(t);
                                break;
                              case Ss:
                                if (
                                  ...
                                  i === a && (t.nextKnownPendingLevel = Cr(o)),
                                  Rs &&
                                    (0 === (o = t.lastPingedTime) || o >= i))
                                ) {
                                  ((t.lastPingedTime = i), yr(t, i));
                                  break;
                                }
                                if (0 !== (o = hr(t)) && o !== i) break;
                                if (0 !== a && a !== i) {
                                  t.lastPingedTime = a;
                                  break;
                                }
                                if (
                                  (1073741823 !== Ls
                                    ? (a = 10 * (1073741821 - Ls) - El())
                                    : 1073741823 === Ms
                                      ? (a = 0)
                                      : ((a = 10 * (1073741821 - Ms) - 5e3),
                                        (o = El()),
                                        (i = 10 * (1073741821 - i) - o),
                                        0 > (a = o - a) && (a = 0),
                                        (a =
                                  ...
                                  t.timeoutHandle = Ja(Pr.bind(null, t), a);
                                  break;
                                }
                                Pr(t);
                                break;
                              case Es:
                                if (1073741823 !== Ms && null !== Ns) {
                                  l = Ms;
                                  var s = Ns;
                                  if (
                          ...
                          if ((dr(t), t.callbackNode === r))
                            return e.bind(null, t);
                        }
                      }
                      return null;
                    }.bind(null, e),
                    { timeout: 10 * (1073741821 - t) - El() },
                  )),
            (e.callbackNode = t));
        }
      }
    ...
    function pr(e) {
      var t = e.lastExpiredTime;
      if (((t = 0 !== t ? t : 1073741823), (Ts & (ys | gs)) !== ms))
        throw Error(n(327));
      if ((_r(), (e === Cs && t === Is) || yr(e, t), null !== Ps)) {
        var r = Ts;
        Ts |= ys;
        for (var i = br(); ; )
          try {
        ...
        if ((Ct(), (Ts = r), (ds.current = i), _s === ws))
          throw ((r = zs), yr(e, t), Vr(e, t), dr(e), r);
        if (null !== Ps) throw Error(n(261));
    ...
    function yr(e, t) {
      ...
      if ((-1 !== n && ((e.timeoutHandle = -1), Za(n)), null !== Ps))
        for (n = Ps.return; null !== n; ) {
          var r = n;
          switch (r.tag) {
            case 1:
              null != (r = r.type.childContextTypes) && (ut(ol), ut(al));
              break;
            case 3:
              (Kt(), ut(ol), ut(al));
              break;
      ...
      for (;;) {
        try {
          ...
          if (
            ...
            (Kl = $l = Ql = null),
            (ql = !1),
            null === Ps || null === Ps.return)
          )
            return ((_s = ws), (zs = t), (Ps = null));
          e: {
            var i = e,
              a = Ps.return,
              o = Ps,
    ...
    function br(e) {
      return ((e = ds.current), (ds.current = Gl), null === e ? Gl : e);
    }
    function wr(e, t) {
      (e < Ms && 2 < e && (Ms = e),
        null !== t && e < Ls && 2 < e && ((Ls = e), (Ns = t)));
    }
    function kr(e) {
      e > As && (As = e);
    }
    function xr() {
      for (; null !== Ps; ) Ps = Er(Ps);
    }
    function Sr() {
      for (; null !== Ps && !gl(); ) Ps = Er(Ps);
    }
    function Er(e) {
    ...
    function Tr(e) {
      ...
      do {
        var t = Ps.alternate;
        if (((e = Ps.return), 0 == (2048 & Ps.effectTag))) {
          if (((t = Xn(t, Ps, Is)), 1 === Is || 1 !== Ps.childExpirationTime)) {
            for (var n = 0, r = Ps.child; null !== r; ) {
              var i = r.expirationTime,
                a = r.childExpirationTime;
              (i > n && (n = i), a > n && (n = a), (r = r.sibling));
            }
            Ps.childExpirationTime = n;
          }
          if (null !== t) return t;
          null !== e &&
            0 == (2048 & e.effectTag) &&
            (null === e.firstEffect && (e.firstEffect = Ps.firstEffect),
            null !== Ps.lastEffect &&
              (null !== e.lastEffect &&
                (e.lastEffect.nextEffect = Ps.firstEffect),
              (e.lastEffect = Ps.lastEffect)),
            1 < Ps.effectTag &&
              (null !== e.lastEffect
                ? (e.lastEffect.nextEffect = Ps)
                : (e.firstEffect = Ps),
              (e.lastEffect = Ps)));
        } else {
          if (null !== (t = Qn(Ps))) return ((t.effectTag &= 2047), t);
          null !== e &&
            ((e.firstEffect = e.lastEffect = null), (e.effectTag |= 2048));
        }
        if (null !== (t = Ps.sibling)) return t;
        Ps = e;
      } while (null !== Ps);
      return (_s === bs && (_s = Es), null);
    }
    function Cr(e) {
      ...
      return (
        bt(
          ...
          function (e, t) {
            ...
            if ((Ts & (ys | gs)) !== ms) throw Error(n(327));
            ...
            if (
                        ...
                        for (
                          ...
                          y !== s ||
                            ...
                            y !== f ||
                              (0 !== u && 3 !== y.nodeType) ||
                              (p = h + u),
                            3 === y.nodeType && (h += y.nodeValue.length),
                            null !== (b = y.firstChild);
              ...
              do {
                try {
                  ...
                  if (null === Fs) throw Error(n(330));
                  (Lr(Fs, e), (Fs = Fs.nextEffect));
                }
              } while (null !== Fs);
              Fs = a;
              do {
                try {
                  for (l = e, s = t; null !== Fs; ) {
                    ...
                    switch (1038 & w) {
                      case 2:
                        (rr(Fs), (Fs.effectTag &= -3));
                        break;
                      case 6:
                        (rr(Fs), (Fs.effectTag &= -3), ar(Fs.alternate, Fs));
                        break;
                      case 1024:
                        Fs.effectTag &= -1025;
                        break;
                      case 1028:
                        ((Fs.effectTag &= -1025), ar(Fs.alternate, Fs));
                        break;
                      case 4:
                        ar(Fs.alternate, Fs);
                        break;
              ...
              ((Wa = !!Ga), (Ya = Ga = null), (e.current = r), (Fs = a));
              do {
                try {
                  for (w = e; null !== Fs; ) {
                    var S = Fs.effectTag;
                    if ((36 & S && Zn(w, Fs.alternate, Fs), 128 & S)) {
                      k = void 0;
                      var E = Fs.ref;
                      if (null !== E) {
                        var T = Fs.stateNode;
            ...
            if (Ws) ((Ws = !1), (Vs = e), (Hs = t));
            else
              for (Fs = a; null !== Fs; )
                ((t = Fs.nextEffect), (Fs.nextEffect = null), (Fs = t));
            if (
              ...
              1073741823 === t
                ? e === $s
                  ...
                  : ((Qs = 0), ($s = e))
                : (Qs = 0),
              "function" == typeof Ys && Ys(r.stateNode, i),
              dr(e),
              js)
            )
              throw ((js = !1), (e = Us), (Us = null), e);
            return (Ts & vs) !== ms ? null : (xt(), null);
          }.bind(null, e, t),
        ),
        null
      );
    ...
    function _r() {
      if (90 !== Hs) {
        var e = 97 < Hs ? 97 : Hs;
        return ((Hs = 90), bt(e, zr));
      }
    }
    function zr() {
      if (null === Vs) return !1;
      var e = Vs;
      if (((Vs = null), (Ts & (ys | gs)) !== ms)) throw Error(n(331));
      var t = Ts;
      for (Ts |= gs, e = e.current.firstEffect; null !== e; ) {
        try {
          var r = e;
    ...
    function Mr(e, t, n) {
      (At(e, (t = lr(e, (t = $n(n, t)), 1073741823))),
        null !== (e = fr(e, 1073741823)) && dr(e));
    }
    function Lr(e, t) {
      if (3 === e.tag) Mr(e, e, t);
      else
        for (var n = e.return; null !== n; ) {
          ...
          if (1 === n.tag) {
            ...
            if (
              ...
              (At(n, (e = sr(n, (e = $n(t, e)), 1073741823))),
                null !== (n = fr(n, 1073741823)) && dr(n));
              break;
            }
          }
          n = n.return;
    ...
    function Nr(e, t, n) {
      ...
      (null !== r && r.delete(t),
        Cs === e && Is === n
          ? _s === Ss || (_s === xs && 1073741823 === Ms && El() - Os < Ds)
            ? yr(e, Is)
            : (Rs = !0)
          : Wr(e, n) &&
            ((0 !== (t = e.lastPingedTime) && t < n) ||
              ((e.lastPingedTime = n), dr(e))));
    }
    function Ar(e, t, n, r) {
      ((this.tag = e),
        (this.key = n),
    ...
    function Dr(e, t, r, i, a, o) {
      var l = 2;
      if (((i = e), "function" == typeof e)) Rr(e) && (l = 1);
      else if ("string" == typeof e) l = 5;
      else
        e: switch (e) {
          case Zi:
            return Fr(r.children, a, o, t);
          case ia:
            ((l = 8), (a |= 7));
            break;
          case ea:
          ...
          case ta:
            return (
              ((e = Zs(12, r, t, 8 | a)).elementType = ta),
              (e.type = ta),
              (e.expirationTime = o),
              e
            );
    ...
    function Qr(e, t, r, i) {
      ...
      e: if (r) {
        t: {
          if (j((r = r._reactInternalFiber)) !== r || 1 !== r.tag)
            throw Error(n(170));
          var s = r;
          do {
            switch (s.tag) {
    ...
    function qr(e, t) {
      (Kr(e, t), (e = e.alternate) && Kr(e, t));
    }
    function Gr(e, t, n) {
      var r = new Br(e, t, (n = null != n && !0 === n.hydrate)),
        i = Zs(3, null, null, 2 === t ? 7 : 1 === t ? 3 : 0);
      ((r.current = i),
        (i.stateNode = r),
        Mt(i),
        (e[ro] = r.current),
        ...
        if (
          ((a = n._reactRootContainer =
            (function (e, t) {
              ...
              return new Gr(e, 0, t ? { hydrate: !0 } : void 0);
            })(n, r)),
          (o = a._internalRoot),
          "function" == typeof i)
        ) {
    ...
    var ei = function (e, t, n, r, i, a, o, l, s) {
      ...
      vi = t.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.assign,
      yi = null,
      gi = null,
      bi = null,
      wi = function (e, t) {
      ...
      Ei = !1,
      Ti = !1,
      Ci = t.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.Scheduler,
      Pi = Ci.unstable_cancelCallback,
      Ii = Ci.unstable_now,
      _i = Ci.unstable_scheduleCallback,
      zi = Ci.unstable_shouldYield,
      Mi = Ci.unstable_requestPaint,
      Li = Ci.unstable_runWithPriority,
      Ni = Ci.unstable_getCurrentPriorityLevel,
      Ai = Ci.unstable_ImmediatePriority,
      Ri = Ci.unstable_UserBlockingPriority,
      Oi = Ci.unstable_NormalPriority,
      Di = Ci.unstable_LowPriority,
      Fi = Ci.unstable_IdlePriority,
      ji =
    ...
    ("children dangerouslySetInnerHTML defaultValue defaultChecked innerHTML suppressContentEditableWarning suppressHydrationWarning style"
      ...
      [
        ...
        var t = e[0];
        Vi[t] = new d(t, 1, !1, e[1], null, !1);
      }),
      ["contentEditable", "draggable", "spellCheck", "value"].forEach(
        function (e) {
          Vi[e] = new d(e, 2, !1, e.toLowerCase(), null, !1);
        },
      ),
      [
        "autoReverse",
        ...
        Vi[e] = new d(e, 2, !1, e, null, !1);
      }),
      "allowFullScreen async autoFocus autoPlay controls default defer disabled disablePictureInPicture formNoValidate hidden loop noModule noValidate open playsInline readOnly required reversed scoped seamless itemScope"
        .split(" ")
        .forEach(function (e) {
          Vi[e] = new d(e, 3, !1, e.toLowerCase(), null, !1);
        }),
      ["checked", "multiple", "muted", "selected"].forEach(function (e) {
        Vi[e] = new d(e, 3, !0, e, null, !1);
      }),
      ["capture", "download"].forEach(function (e) {
        Vi[e] = new d(e, 4, !1, e, null, !1);
      }),
      ["cols", "rows", "size", "span"].forEach(function (e) {
        Vi[e] = new d(e, 6, !1, e, null, !1);
      }),
      ["rowSpan", "start"].forEach(function (e) {
        Vi[e] = new d(e, 5, !1, e.toLowerCase(), null, !1);
      }));
    var Hi = /[\-:]([a-z])/g,
      Xi = function (e) {
    ...
    ("accent-height alignment-baseline arabic-form baseline-shift cap-height clip-path clip-rule color-interpolation color-interpolation-filters color-profile color-rendering dominant-baseline enable-background fill-opacity fill-rule flood-color flood-opacity font-family font-size font-size-adjust font-stretch font-style font-variant font-weight glyph-name glyph-orientation-horizontal glyph-orientation-vertical horiz-adv-x horiz-origin-x image-rendering letter-spacing lighting-color marker-end marker-mid marker-start overline-position overline-thickness paint-order panose-1 pointer-events rendering-intent shape-rendering stop-color stop-opacity strikethrough-position strikethrough-thickness stroke-dasharray stroke-dashoffset stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width text-anchor text-decoration text-rendering underline-position underline-thickness unicode-bidi unicode-range units-per-em v-alphabetic v-hanging v-ideographic v-mathematical vector-effect vert-adv-y vert-origin-x vert-origin-y word-spacing writing-mode xmlns:xlink x-height"
      .split(" ")
      .forEach(function (e) {
        var t = e.replace(Hi, Xi);
        Vi[t] = new d(t, 1, !1, e, null, !1);
      }),
      "xlink:actuate xlink:arcrole xlink:role xlink:show xlink:title xlink:type"
        .split(" ")
        .forEach(function (e) {
          var t = e.replace(Hi, Xi);
          Vi[t] = new d(t, 1, !1, e, "http://www.w3.org/1999/xlink", !1);
        }),
      ["xml:base", "xml:lang", "xml:space"].forEach(function (e) {
        var t = e.replace(Hi, Xi);
        Vi[t] = new d(t, 1, !1, e, "http://www.w3.org/XML/1998/namespace", !1);
      }),
      ["tabIndex", "crossOrigin"].forEach(function (e) {
        Vi[e] = new d(e, 1, !1, e.toLowerCase(), null, !1);
      }),
      (Vi.xlinkHref = new d(
        "xlinkHref",
        1,
      ...
      ["src", "href", "action", "formAction"].forEach(function (e) {
        Vi[e] = new d(e, 1, !1, e.toLowerCase(), null, !0);
      }));
    var Qi = t.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
    (Qi.hasOwnProperty("ReactCurrentDispatcher") ||
      (Qi.ReactCurrentDispatcher = { current: null }),
      Qi.hasOwnProperty("ReactCurrentBatchConfig") ||
        (Qi.ReactCurrentBatchConfig = { suspense: null }));
    var $i,
      Ki,
      qi = /^(.*)[\\\/]/,
      Gi = "function" == typeof Symbol && Symbol.for,
      Yi = Gi ? Symbol.for("react.element") : 60103,
      Ji = Gi ? Symbol.for("react.portal") : 60106,
      Zi = Gi ? Symbol.for("react.fragment") : 60107,
      ea = Gi ? Symbol.for("react.strict_mode") : 60108,
      ta = Gi ? Symbol.for("react.profiler") : 60114,
      na = Gi ? Symbol.for("react.provider") : 60109,
      ra = Gi ? Symbol.for("react.context") : 60110,
      ia = Gi ? Symbol.for("react.concurrent_mode") : 60111,
      aa = Gi ? Symbol.for("react.forward_ref") : 60112,
      oa = Gi ? Symbol.for("react.suspense") : 60113,
      la = Gi ? Symbol.for("react.suspense_list") : 60120,
      sa = Gi ? Symbol.for("react.memo") : 60115,
      ua = Gi ? Symbol.for("react.lazy") : 60116,
      ca = Gi ? Symbol.for("react.block") : 60121,
    ...
    var ya = D("animationend"),
      ga = D("animationiteration"),
      ba = D("animationstart"),
      wa = D("transitionend"),
      ka =
      ...
      xa = new ("function" == typeof WeakMap ? WeakMap : Map)(),
      Sa = null,
      Ea = function (e) {
        if (e) {
    ...
    (vi(Be.prototype, {
      ...
      He(Be));
    var lo = Be.extend({ data: null }),
      so = Be.extend({ data: null }),
      uo = [9, 13, 27, 32],
      co = mi && "CompositionEvent" in window,
      fo = null;
    mi && "documentMode" in document && (fo = document.documentMode);
    var ho = mi && "TextEvent" in window && !fo,
      po = mi && (!co || (fo && 8 < fo && 11 >= fo)),
        ...
        extractEvents: function (e, t, n, r, i) {
            ...
            e: {
              switch (e) {
                case "compositionstart":
                  var o = vo.compositionStart;
                  break e;
                case "compositionend":
                  o = vo.compositionEnd;
                  break e;
                case "compositionupdate":
                  o = vo.compositionUpdate;
                  break e;
              }
              o = void 0;
            }
          ...
          return (
            o
              ? (po &&
                  "ko" !== n.locale &&
                  (go || o !== vo.compositionStart
                    ? o === vo.compositionEnd && go && (a = Fe())
                    : ((ao = "value" in (io = r) ? io.value : io.textContent),
                      (go = !0))),
                (i = lo.getPooled(o, t, n, r)),
                a ? (i.data = a) : null !== (a = Qe(n)) && (i.data = a),
                De(i),
                (a = i))
              : (a = null),
            (e = ho
              ? (function (e, t) {
                  switch (e) {
                    case "compositionend":
                      return Qe(t);
                    case "keypress":
                      return 32 !== t.which ? null : ((yo = !0), mo);
                    case "textInput":
                      return (e = t.data) === mo && yo ? null : e;
                    default:
                      return null;
                  }
                })(e, n)
              : (function (e, t) {
                  if (go)
                    return "compositionend" === e || (!co && Xe(e, t))
                      ? ((e = Fe()), (oo = ao = io = null), (go = !1), e)
                      : null;
                  switch (e) {
                    case "paste":
                      return null;
              ...
              ? (((t = so.getPooled(vo.beforeInput, t, n, r)).data = e), De(t))
              : (t = null),
    ...
    var To = {
        ...
        extractEvents: function (e, t, n, r, i) {
          var a = (i = t ? _e(t) : window).nodeName && i.nodeName.toLowerCase();
      ...
      Co = Be.extend({ view: null, detail: null }),
      Po = {
        Alt: "altKey",
        Control: "ctrlKey",
        Meta: "metaKey",
      ...
      Lo = Co.extend({
        ...
        movementX: function (e) {
          ...
          return (
            (Io = e.screenX),
            zo ? ("mousemove" === e.type ? e.screenX - t : 0) : ((zo = !0), 0)
          );
        },
        movementY: function (e) {
          ...
          return (
            (_o = e.screenY),
            Mo ? ("mousemove" === e.type ? e.screenY - t : 0) : ((Mo = !0), 0)
          );
        },
      }),
      No = Lo.extend({
      ...
      Ro = {
        ...
        extractEvents: function (e, t, n, r, i) {
          ...
          if (
            ...
            e: {
              for (u = c, o = 0, e = l = r; e; e = Me(e)) o++;
              for (e = 0, t = u; t; t = Me(t)) e++;
              for (; 0 < o - e; ) ((l = Me(l)), o--);
              for (; 0 < e - o; ) ((u = Me(u)), e--);
              for (; o--; ) {
          ...
          for (
            ...
            (r.push(c), (c = Me(c)));
          for (c = 0; c < l.length; c++) Re(l[c], "bubbled", s);
          for (c = r.length; 0 < c--; ) Re(r[c], "captured", n);
          return 0 == (64 & i) ? [s] : [s, n];
        },
      },
      Oo =
      ...
      Fo = mi && "documentMode" in document && 11 >= document.documentMode,
      jo = {
        select: {
          phasedRegistrationNames: {
            bubbled: "onSelect",
      ...
      $o = Co.extend({ relatedTarget: null }),
      Ko = {
        Esc: "Escape",
        Spacebar: " ",
        Left: "ArrowLeft",
      ...
      Yo = Lo.extend({ dataTransfer: null }),
      Jo = Co.extend({
        touches: null,
        targetTouches: null,
        changedTouches: null,
      ...
      tl = {
        ...
        extractEvents: function (e, t, n, r, i) {
          ...
          return (De((t = e.getPooled(i, t, n, r))), t);
        },
      };
    (!(function (e) {
      if (ui) throw Error(n(101));
      ((ui = Array.prototype.slice.call(e)), a());
    })(
    ...
    var nl = [],
      ...
      zl = 2,
      Ml = !1,
      Ll = Qi.ReactCurrentBatchConfig,
      Nl = new t.Component().refs,
      Al = {
        isMounted: function (e) {
      ...
      Bl = { current: Fl },
      Wl = { current: 0 },
      Vl = Qi.ReactCurrentDispatcher,
      Hl = Qi.ReactCurrentBatchConfig,
      Xl = 0,
      Ql = null,
      $l = null,
      Kl = null,
      ...
      Yl = {
        ...
        useTransition: function (e) {
          var t = sn(!1),
            n = t[0];
          return ((t = t[1]), [bn(xn.bind(null, t, e), [t, e]), n]);
        },
      },
      Jl = {
        readContext: zt,
        ...
        useTransition: function (e) {
          var t = on(an),
            n = t[0];
          return ((t = t[1]), [wn(xn.bind(null, t, e), [t, e]), n]);
        },
      },
      Zl = {
        readContext: zt,
      ...
      hs = Math.ceil,
      ds = Qi.ReactCurrentDispatcher,
      ps = Qi.ReactCurrentOwner,
      ms = 0,
      vs = 8,
      ys = 16,
      gs = 32,
      ...
      Ks = 0,
      qs = function (e, t) {
        if (50 < Qs) throw ((Qs = 0), ($s = null), Error(n(185)));
        if (null !== (e = fr(e, t))) {
          var r = yt();
          (1073741823 === t
            ? (Ts & vs) !== ms && (Ts & (ys | gs)) === ms
              ? pr(e)
              : (dr(e), Ts === ms && xt())
            : dr(e),
            (4 & Ts) === ms ||
              ...
              (null === Xs
                ? (Xs = new Map([[e, t]]))
                : (void 0 === (r = Xs.get(e)) || r > t) && Xs.set(e, t)));
        }
      },
      Gs = function (e, t, r) {
        var i = t.expirationTime;
        if (null !== e) {
          ...
          if (e.memoizedProps !== a || ol.current) is = !0;
          else {
            if (i < r) {
              switch (((is = !1), t.tag)) {
                case 3:
                ...
                case 10:
                  ((i = t.memoizedProps.value),
                    (a = t.type._context),
                    ct(Tl, a._currentValue),
                    (a._currentValue = i));
                  break;
                case 13:
                  if (null !== t.memoizedState)
                    return 0 !== (i = t.child.childExpirationTime) && i >= r
                      ? jn(e, t, r)
                      : (ct(Wl, 1 & Wl.current),
                        null !== (t = Vn(e, t, r)) ? t.sibling : null);
                  ct(Wl, 1 & Wl.current);
                  break;
                case 19:
                  if (
        ...
        switch (((t.expirationTime = 0), t.tag)) {
          case 2:
            if (
              ...
              ("function" == typeof l && Ft(t, i, l, e),
                (a.updater = Al),
                (t.stateNode = a),
                (a._reactInternalFiber = t),
                Wt(t, i, e, r),
                (t = Dn(null, t, i, !0, o, r)));
            } else ((t.tag = 0), zn(null, t, a, r), (t = t.child));
            return t;
          case 16:
            e: {
              if (
              ...
              switch (
                ...
                (o = t.tag =
                  (function (e) {
                    if ("function" == typeof e) return Rr(e) ? 1 : 0;
                    if (null != e) {
                      if ((e = e.$$typeof) === aa) return 11;
                      if (e === sa) return 14;
                    }
                    return 2;
                  })(a)),
          ...
          case 0:
            return (
              (i = t.type),
              (a = t.pendingProps),
              Rn(e, t, i, (a = t.elementType === i ? a : Tt(i, a)), r)
            );
          case 1:
            return (
              (i = t.type),
              (a = t.pendingProps),
              On(e, t, i, (a = t.elementType === i ? a : Tt(i, a)), r)
            );
          case 3:
            if ((Fn(t), (i = t.updateQueue), null === e || null === i))
              throw Error(n(282));
            if (
              ((i = t.pendingProps),
              ...
              if (
                ((a = t.stateNode.hydrate) &&
                  ((ts = Te(t.stateNode.containerInfo.firstChild)),
                  (es = t),
                  (a = ns = !0)),
                a)
              )
                for (r = Dl(t, null, i, r), t.child = r; r; )
          ...
          case 5:
            return (
              ...
              Ee(i, a)
                ? (l = null)
                : null !== o && Ee(i, o) && (t.effectTag |= 16),
              An(e, t),
              4 & t.mode && 1 !== r && a.hidden
                ? ((t.expirationTime = t.childExpirationTime = 1), (t = null))
                : (zn(e, t, l, r), (t = t.child)),
              t
            );
          case 6:
          ...
          case 4:
            return (
              $t(t, t.stateNode.containerInfo),
              (i = t.pendingProps),
              null === e ? (t.child = Ol(t, null, i, r)) : zn(e, t, i, r),
              t.child
            );
          case 11:
            return (
              (i = t.type),
              (a = t.pendingProps),
              Mn(e, t, i, (a = t.elementType === i ? a : Tt(i, a)), r)
            );
          case 7:
            return (zn(e, t, t.pendingProps, r), t.child);
          case 8:
          case 12:
            return (zn(e, t, t.pendingProps.children, r), t.child);
          case 10:
            e: {
              ((i = t.type._context),
                (a = t.pendingProps),
              ...
              if ((ct(Tl, s._currentValue), (s._currentValue = o), null !== l))
                if (
                  ((s = l.value),
                  0 ===
                    (o = Oo(s, o)
                      ...
                      : 0 |
                        ("function" == typeof i._calculateChangedBits
                          ? i._calculateChangedBits(s, o)
                          : 1073741823)))
                ) {
                  if (l.children === a.children && !ol.current) {
                    t = Vn(e, t, r);
                    break e;
                  }
                } else
          ...
          case 9:
            return (
              ...
              _t(t, r),
              (i = i((a = zt(a, o.unstable_observedBits)))),
              (t.effectTag |= 1),
              zn(e, t, i, r),
              t.child
            );
          case 14:
            return (
              (o = Tt((a = t.type), t.pendingProps)),
              Ln(e, t, a, (o = Tt(a.type, o)), i, r)
            );
          case 15:
            return Nn(e, t, t.type, t.pendingProps, i, r);
          case 17:
            return (
              (i = t.type),
              (a = t.pendingProps),
              (a = t.elementType === i ? a : Tt(i, a)),
              null !== e &&
                ((e.alternate = null),
                (t.alternate = null),
                (t.effectTag |= 2)),
    ...
    ((Gr.prototype.render = function (e) {
      Qr(e, this._internalRoot, null, null);
    }),
      (Gr.prototype.unmount = function () {
    ...
    var eu = function (e) {
      ...
      tu = function (e) {
        13 === e.tag && (qs(e, 3), qr(e, 3));
      },
      nu = function (e) {
        if (13 === e.tag) {
          var t = ur();
          ((t = cr(t, e, null)), qs(e, t), qr(e, t));
        }
      };
    ((yi = function (e, t, r) {
      switch (t) {
        case "input":
          if ((T(e, r), (t = r.name), "radio" === r.type && null != t)) {
        ...
        case "textarea":
          ...
          break;
        case "select":
          null != (t = r.value) && _(e, !!r.multiple, t, !1);
      }
    }),
      (wi = mr),
      (ki = function (e, t, n, r, i) {
        ...
        Ts |= 4;
        try {
          return bt(98, e.bind(null, t, n, r, i));
        } finally {
          (Ts = a) === ms && xt();
        }
      }),
    ...
    (!(function (e) {
      ...
      (e.findDOMNode = function (e) {
        ...
        return (e = null === (e = W(t)) ? null : e.stateNode);
      }),
      (e.flushSync = function (e, t) {
        if ((Ts & (ys | gs)) !== ms) throw Error(n(187));
        var r = Ts;
        Ts |= 1;
        try {
      ...
      (e.hydrate = function (e, t, r) {
        if (!Yr(t)) throw Error(n(200));
        return Jr(null, e, t, !0, r);
      }),
      (e.render = function (e, t, r) {
        if (!Yr(t)) throw Error(n(200));
        return Jr(null, e, t, !1, r);
      }),
      (e.unmountComponentAtNode = function (e) {
        if (!Yr(e)) throw Error(n(40));
        return (
  ...
  (function () {
    ...
    "undefined" != typeof module && module.exports
      ...
      : System.registerDynamic("classnames", [], !1, function (e, n, r) {
          return function () {
            return t;
          }.call(this);
        });
  ...
  (function () {
    ...
    function t(n) {
      return (function (n, r) {
        var i,
          ...
          m = "";
        for (a = 0; a < p; a++)
          if ("string" == typeof n[a]) m += n[a];
          else if ("object" == typeof n[a]) {
            if ((l = n[a]).keys)
              for (i = r[d], o = 0; o < l.keys.length; o++) {
                if (null == i)
                  throw new Error(
                    t(
            ...
            else i = l.param_no ? r[l.param_no] : r[d++];
            if (
              (e.not_type.test(l.type) &&
                e.not_primitive.test(l.type) &&
                i instanceof Function &&
                (i = i()),
              e.numeric_arg.test(l.type) && "number" != typeof i && isNaN(i))
            )
              throw new TypeError(
                t("[sprintf] expecting number but found %T", i),
              );
            switch ((e.number.test(l.type) && (f = i >= 0), l.type)) {
              case "b":
              ...
              case "i":
                ...
                break;
              case "j":
                i = JSON.stringify(i, null, l.width ? parseInt(l.width) : 0);
                break;
              case "e":
                i = l.precision
              ...
              case "s":
                ((i = String(i)),
                  (i = l.precision ? i.substring(0, l.precision) : i));
                break;
              case "t":
                ((i = String(!!i)),
                  (i = l.precision ? i.substring(0, l.precision) : i));
              ...
              : (!e.number.test(l.type) || (f && !l.sign)
                ...
                (u = l.pad_char
                  ? "0" === l.pad_char
                    ...
                    : l.pad_char.charAt(1)
                  : " "),
                (c = l.width - (h + i).length),
                (s = l.width && c > 0 ? u.repeat(c) : ""),
                (m += l.align ? h + i + s : "0" === u ? h + s + i : s + h + i));
          }
        return m;
      })(
        (function (t) {
          ...
          var n,
            ...
            o = 0;
          for (; i; ) {
            if (null !== (n = e.text.exec(i))) a.push(n[0]);
            else if (null !== (n = e.modulo.exec(i))) a.push("%");
            else {
              if (null === (n = e.placeholder.exec(i)))
              ...
              if (n[2]) {
                ...
                var l = [],
                  s = n[2],
                  u = [];
                if (null === (u = e.key.exec(s)))
                  throw new SyntaxError(
                    "[sprintf] failed to parse named argument key",
                  );
                for (l.push(u[1]); "" !== (s = s.substring(u[0].length)); )
                  if (null !== (u = e.key_access.exec(s))) l.push(u[1]);
                  else {
                    if (null === (u = e.index_access.exec(s)))
                      throw new SyntaxError(
                        "[sprintf] failed to parse named argument key",
                      );
                    l.push(u[1]);
    ...
    ("undefined" != typeof exports &&
      ((exports.sprintf = t), (exports.vsprintf = n)),
      "undefined" != typeof window &&
        ((window.sprintf = t),
        (window.vsprintf = n),
        System.registerDynamic("sprintf-js", [], !1, function (e, r, i) {
          return function () {
  ...
  System.register(
    "@puzzl/core/lib/async/Task.js",
    ["../event/EventDispatcher", "./cancellation"],
    function (e, t) {
      "use strict";
      var n, r, i, a;
      return {
        ...
        execute: function () {
          ...
          e(
            ...
            class {
              constructor(e) {
                ((this.func = e),
                  (this.status = a.NotStarted),
                  (this.onTaskEnded = new n()),
                  (this.tokenSource = new r()));
              }
              reset() {
                return i(this, void 0, void 0, function* () {
                  if (this.status === a.InProgress)
              ...
              cancel() {
                this.status === a.InProgress && this.tokenSource.cancel();
              }
              start() {
                return i(this, void 0, void 0, function* () {
                  if (this.status !== a.NotStarted)
                    throw new Error("Task already started or completed");
                  try {
                    ((this.lastError = void 0),
                      (this.lastResult = void 0),
                      (this.status = a.InProgress),
                      (this.lastResult = yield this.func(
                        this.tokenSource.token,
                      )),
                      (this.status = a.Finished));
                  } catch (e) {
                    ((this.lastError = e), (this.status = a.Error));
                  }
                  if (
              ...
              wait() {
                return i(this, void 0, void 0, function* () {
                  if (this.status === a.Error)
                    return Promise.reject(this.lastError);
                  if (this.status === a.Finished)
                  ...
                  throw this.status === a.NotStarted
                    ? new Error("Can't wait for task that was not even started")
                    : new Error(`Unknown task state ${this.status}`);
                });
              }
              startOrWait() {
                return i(this, void 0, void 0, function* () {
                  return this.status === a.NotStarted
                    ? yield this.start()
                    : yield this.wait();
                });
              }
  ...
  System.register(
    "@puzzl/core/lib/async/sleep.js",
    ["./cancellation"],
    function (e, t) {
      "use strict";
      var n;
      return (
        e("sleep", function (e, t) {
          let r;
          return new Promise((i, a) => {
            ((r = setTimeout(() => {
              ...
              t &&
                t.register(() => {
                  (clearTimeout(r), (r = void 0), a(new n(t)));
                }));
          });
        }),
        {
  ...
  System.register(
    "@puzzl/core/lib/async/cancellation/CancellationToken.js",
    ["./OperationCanceledError", "./internal"],
    function (e, t) {
      "use strict";
      var n, r, i;
      return {
        ...
        execute: function () {
          e(
            ...
            class {
              constructor(e) {
                ((this.source = e), (this.cancelled = !1));
              }
              throwIfCancelled() {
                if (this.isCancelled()) throw new n(this);
              }
              isCancelled() {
                return !0 === this.cancelled;
              }
              [r]() {
                this.cancelled = !0;
              }
  ...
  System.register(
    "@puzzl/core/lib/async/cancellation/internal.js",
    [],
    function (e, t) {
      "use strict";
      return {
  ...
  System.register(
    "@puzzl/core/lib/async/cancellation/CancellationTokenSource.js",
    ["../../event/EventDispatcher", "./CancellationToken", "./internal"],
    function (e, t) {
      "use strict";
      var n, r, i, a;
      return {
        ...
        execute: function () {
          e(
            ...
            class {
              constructor() {
                ((this.onCancel = new n()), (this.token = new r(this)));
              }
              cancel() {
                (this.token[i](), this.onCancel.dispatch(this, void 0));
              }
              [a](e) {
                (this.onCancel.subscribe(() => e()),
                  this.token.isCancelled() && e());
              }
            },
          );
        },
  ...
  System.register(
    "@puzzl/core/lib/async/cancellation/OperationCanceledError.js",
    [],
    function (e, t) {
      "use strict";
      return {
        ...
        execute: function () {
          e(
            ...
            class extends Error {
              constructor(e) {
                (super(), (this.cancellationToken = e));
              }
            },
          );
        },
  ...
  System.register(
    "@puzzl/core/lib/async/cancellation/index.js",
    [
      "./CancellationToken",
      "./CancellationTokenSource",
      "./OperationCanceledError",
    ...
    function (e, t) {
      ...
      return {
        setters: [
          function (t) {
            var n = {};
            ((n.CancellationToken = t.CancellationToken), e(n));
          },
          function (t) {
            var n = {};
            ((n.CancellationTokenSource = t.CancellationTokenSource), e(n));
          },
          function (t) {
            var n = {};
            ((n.OperationCanceledError = t.OperationCanceledError), e(n));
          },
        ],
        execute: function () {},
      };
  ...
  System.register(
    "@puzzl/core/lib/event/AsyncEventDispatcher.js",
    [],
    function (e, t) {
      "use strict";
      return {
        ...
        execute: function () {
          e(
            ...
            class {
              ...
              subscribeOnce(e) {
                let t = (n, r) => (this.unsubscribe(t), (t = void 0), e(n, r));
                this.subscribe(t);
              }
              dispatch(e, t) {
  ...
  System.register("@puzzl/core/lib/math/interval.js", [], function (e, t) {
    "use strict";
    return (
      e("intersect", function (e, t) {
        return (e[0] <= t[0] && e[1] >= t[0]) || (t[0] <= e[0] && t[1] >= e[0]);
      }),
      { setters: [], execute: function () {} }
    );
  }),
  System.register("@puzzl/core/lib/math/number.js", [], function (e, t) {
    "use strict";
    return (
      e("clamp", function (e, t, n) {
        return Math.min(n, Math.max(e, t));
      }),
      e("isBetween", function (e, t, n) {
        return e >= t && e <= n;
      }),
      { setters: [], execute: function () {} }
    );
  ...
  System.register(
    "@puzzl/core/lib/event/EventDispatcher.js",
    [],
    function (e, t) {
      "use strict";
      return {
        ...
        execute: function () {
          e(
            ...
            class {
              ...
              subscribeOnce(e) {
                let t = (n, r) => {
                  (e(n, r), this.unsubscribe(t), (t = void 0));
                };
                this.subscribe(t);
              }
              dispatch(e, t) {
                this.listeners.forEach((n) => n(t, e));
              }
              asEvent() {
                return this;
              }
  ...
  System.register(
    "@puzzl/core/lib/pattern/BoxedVar.js",
      ...
      return {
        ...
        execute: function () {
          e(
            ...
            class {
              constructor(e) {
                ((this._onChange = new n()), void 0 !== e && (this.value = e));
              }
              get value() {
                return this._value;
              }
              set value(e) {
                ((this._value = e), this._onChange.dispatch(this, e));
              }
              get onChange() {
  ...
  System.register("@puzzl/core/lib/regexp.js", [], function (e, t) {
    "use strict";
    return (
      e("escape", function (e) {
        return e.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
  ...
  System.register("@puzzl/core/lib/string.js", [], function (e, t) {
    "use strict";
    return (
  ...
  System.registerDynamic("three.meshline", ["three"], !0, function (e, t, n) {
    this || self;
    (function () {
      "use strict";
      var r = void 0 !== e,
        i = this.THREE || (r && e("three"));
      ...
      function l(e) {
        ...
        (i.Material.call(this),
          ...
          (this.map = t(e.map, null)),
          (this.useMap = t(e.useMap, 0)),
          (this.alphaMap = t(e.alphaMap, null)),
          (this.useAlphaMap = t(e.useAlphaMap, 0)),
          (this.color = t(e.color, new i.Color(16777215))),
          (this.opacity = t(e.opacity, 1)),
          (this.resolution = t(e.resolution, new i.Vector2(1, 1))),
          (this.sizeAttenuation = t(e.sizeAttenuation, 1)),
          (this.near = t(e.near, 1)),
          (this.far = t(e.far, 1)),
          (this.dashArray = t(e.dashArray, 0)),
          (this.dashOffset = t(e.dashOffset, 0)),
          (this.dashRatio = t(e.dashRatio, 0.5)),
          (this.useDash = 0 !== this.dashArray ? 1 : 0),
          (this.visibility = t(e.visibility, 1)),
          (this.alphaTest = t(e.alphaTest, 0)),
          (this.repeat = t(e.repeat, new i.Vector2(1, 1))));
        var n = new i.RawShaderMaterial({
          uniforms: {
        ...
        return (
          ...
          delete e.useMap,
          delete e.alphaMap,
          delete e.useAlphaMap,
          delete e.color,
          delete e.opacity,
          delete e.resolution,
          delete e.sizeAttenuation,
          delete e.near,
          delete e.far,
          delete e.dashArray,
          delete e.dashOffset,
      ...
      ((a.prototype.setGeometry = function (e, t) {
        ...
        if ((i.BufferGeometry, e instanceof Float32Array || e instanceof Array))
        ...
        (a.prototype.process = function () {
          ...
          for (r = 0; r < n - 1; r++) {
            var a = 2 * r;
            (this.indices_array.push(a, a + 1, a + 2),
              this.indices_array.push(a + 2, a + 1, a + 3));
          }
          (this.attributes
            ...
            : (this.attributes = {
                position: new i.BufferAttribute(
                  new Float32Array(this.positions),
                  3,
                ),
                previous: new i.BufferAttribute(
                  new Float32Array(this.previous),
                  3,
                ),
                ...
                index: new i.BufferAttribute(
                  new Uint16Array(this.indices_array),
                  1,
                ),
                counters: new i.BufferAttribute(
        ...
        (l.prototype = Object.create(i.Material.prototype)),
        (l.prototype.constructor = l),
        (l.prototype.copy = function (e) {
          return (
            i.Material.prototype.copy.call(this, e),
        ...
        void 0 !== t
          ? (void 0 !== n &&
              n.exports &&
              (t = n.exports = { MeshLine: a, MeshLineMaterial: l }),
            (t.MeshLine = a),
            (t.MeshLineMaterial = l))
          : ((this.MeshLine = a), (this.MeshLineMaterial = l)));
    }).call(t);
  }),
  System.registerDynamic("mersenne-twister", [], !0, function (e, t, n) {
    this || self;
    var r = function (e) {
    ...
    ((r.prototype.init_seed = function (e) {
      ...
      (r.prototype.init_by_array = function (e, t) {
        var n, r, i;
        for (
          this.init_seed(19650218), n = 1, r = 0, i = this.N > t ? this.N : t;
          i;
          i--
        ) {
  ...
  System.register("detect-gpu", [], function (e, t) {
    "use strict";
    return {
      setters: [],
      execute: function () {
        ...
        function u(e, t) {
          ...
          if (((i -= o), 0 === (r -= o))) return i;
          let u,
            c,
            f = 0,
            h = 0,
            d = 0;
          for (; h < r; ) ((s[h] = e.charCodeAt(o + h)), (l[h] = ++h));
          for (; d < i; )
            for (a = t.charCodeAt(o + d), u = d++, f = d, h = 0; h < r; h++)
              ((c = a === s[h] ? u : u + 1),
                (u = l[h]),
                (f = l[h] = u > f ? (c > f ? f + 1 : c) : c > u ? u + 1 : c));
          return f;
        }
        function c(e) {
          return null != e;
        ...
        e(
          ...
          ({
            ...
            desktopTiers: l = [0, 15, 30, 60],
            override: s = {},
            glContext: f,
            failIfMajorPerformanceCaveat: h = !1,
            benchmarksURL:
              d = "https://unpkg.com/detect-gpu@5.0.42/dist/benchmarks",
          } = {}) =>
            t(void 0, void 0, void 0, function* () {
              const p = {};
              if (i) return { tier: 0, type: "SSR" };
              const {
                isIpad: m = !!(null == a ? void 0 : a.isIpad),
                isMobile: v = !!(null == a ? void 0 : a.isMobile),
                screenSize: y = window.screen,
                loadBenchmarks: g = (e) =>
                  t(void 0, void 0, void 0, function* () {
                    const t = yield fetch(`${d}/${e}`).then((e) => e.json());
              ...
              if (b) k = [(b = r(b))];
                ...
                const e =
                  ...
                  })(null == a ? void 0 : a.isSafari12, h);
                if (!e) return w(0, "WEBGL_UNSUPPORTED");
                const t = (null == a ? void 0 : a.isFirefox)
                  ? null
                    ...
                    return "apple gpu" === t
                      ? (function (e, t, n) {
                          ...
                          const r = (function (e) {
                              ...
                              return (
                                e.readPixels(0, 0, 1, 1, 6408, 5121, o),
                                e.deleteProgram(r),
                                e.deleteBuffer(i),
                                o.join("")
                              );
              ...
              const S = (yield Promise.all(
                k.map(function (e) {
                  ...
                  return t(this, void 0, void 0, function* () {
                    ...
                    if (!t) return;
                    const r = `${v ? "m" : "d"}-${t}${m ? "-ipad" : ""}.json`,
                      i = (p[r] =
                        null !== (n = p[r]) && void 0 !== n ? n : g(r));
                    let a;
                    try {
                      a = yield i;
                    } catch (t) {
                    ...
                    const l = (function (e) {
                      ...
                      return null !==
                        (t =
                          null == n
                            ? void 0
                            : n.join("").replace(/\W|amd/g, "")) && void 0 !== t
                        ? t
                        : "";
                    })(e);
                    let s = a.filter(([, e]) => e === l);
                    s.length || (s = a.filter(([t]) => t.includes(e)));
                    const c = s.length;
                    if (0 === c) return;
                    const f = e
                      .split(/[.,()\[\]/\s]/g)
                      .sort()
                      .filter((e, t, n) => 0 === t || e !== n[t - 1])
                      .join(" ");
                    let h,
                      [d, , , , b] =
                        c > 1
                ...
                .filter(c)
                .sort(([e = Number.MAX_VALUE, t], [n = Number.MAX_VALUE, r]) =>
                  e === n ? t - r : e - n,
                );
              if (!S.length) {
                const e = n.find((e) => b.includes(e));
                return e
                  ? w(0, "BLOCKLISTED", e)
                  : w(1, "FALLBACK", `${b} (${x})`);
              }
              const [, E, T, C] = S[0];
              if (-1 === E) return w(0, "BLOCKLISTED", T, E, C);
              const P = v ? e : l;
              let I = 0;
              for (let e = 0; e < P.length; e++) E >= P[e] && (I = e);
              return w(I, "BENCHMARK", T, E, C);
            }),
        );
      },
    };
  }),
  System.register("liang-barsky", [], function (e, t) {
    "use strict";
    var n, r, i;
    function a(e, t, r) {
      var i = r[0],
        a = r[1];
      if (Math.abs(t) < n) return e < 0;
      var o = e / t;
      if (t > 0) {
        if (o > a) return 0;
        o > i && (r[0] = o);
    ...
    function o(e, t, o, l, s) {
      ...
      if (
        (void 0 === l || void 0 === s
          ? ((l = e), (s = t))
          : ((l[0] = e[0]), (l[1] = e[1]), (s[0] = t[0]), (s[1] = t[1])),
        Math.abs(f) < n &&
          Math.abs(h) < n &&
          u >= o[0] &&
          u <= o[2] &&
  ...
  System.register(
    ...
    [
      ...
      "@puzzl/core/lib/event/EventDispatcher",
      "@puzzl/core/lib/event/AsyncEventDispatcher",
      "@puzzl/core/lib/math/interval",
      "@puzzl/core/lib/math/number",
      "@puzzl/core/lib/pattern/BoxedVar",
      "@puzzl/core/lib/regexp",
      "@puzzl/core/lib/string",
      "three.meshline",
      "mersenne-twister",
      "detect-gpu",
      "liang-barsky",
