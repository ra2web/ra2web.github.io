const RA2WEB_SW_VERSION = "0.86.5-r6e70aa6-dac8ed531";
const RA2WEB_APP_CACHE = "ra2web-app-" + RA2WEB_SW_VERSION;
const RA2WEB_GAMERES_CACHE = "ra2web-gameres-" + RA2WEB_SW_VERSION;
const RA2WEB_PRECACHE_URLS = ["/","/index.html","/manifest.webmanifest","/js/app.js?v=0.86.5-r6e70aa6-dac8ed531","/js/vendor.js?v=0.86.5-r6e70aa6-dac8ed531","/res/werhdexp.mix?v=0.86.5-r6e70aa6-dac8ed531","/config.json?v=0.86.5-r6e70aa6-dac8ed531","/res/overlay/art.ini?v=0.86.5","/res/overlay/modcd.ini?v=0.86.5","/res/overlay/mpbattle.ini?v=0.86.5","/res/overlay/mpcoop.ini?v=0.86.5","/res/overlay/mpduel.ini?v=0.86.5","/res/overlay/mpfreeforallmd.ini?v=0.86.5","/res/overlay/mpmeat.ini?v=0.86.5","/res/overlay/mpmodes.ini?v=0.86.5","/res/overlay/mpmw.ini?v=0.86.5","/res/overlay/mpnaval.ini?v=0.86.5","/res/overlay/mpspecial.ini?v=0.86.5","/res/overlay/mpteammd.ini?v=0.86.5","/res/overlay/mpunholy.ini?v=0.86.5","/res/overlay/nodogengikills.ini?v=0.86.5","/res/overlay/ra2.csf?v=0.86.5","/res/overlay/rules.ini?v=0.86.5","/res/overlay/soundcd.ini?v=0.86.5","/res/overlay/ui.ini?v=0.86.5"];
