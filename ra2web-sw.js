const RA2WEB_SW_VERSION = "0.83.0-r625a92c";
const RA2WEB_APP_CACHE = "ra2web-app-" + RA2WEB_SW_VERSION;
const RA2WEB_GAMERES_CACHE = "ra2web-gameres-" + RA2WEB_SW_VERSION;
const RA2WEB_IMMUTABLE_PREFIXES = ["/assets/releases/","/runtime/releases/","/res/werhd/releases/","/assets/releases/0.83.0-r625a92c/","/runtime/releases/0.83.0-r625a92c/"];
