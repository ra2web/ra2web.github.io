const RA2WEB_SW_VERSION = "0.86.1-r7695e77-d0bc1d756";
const RA2WEB_APP_CACHE = "ra2web-app-" + RA2WEB_SW_VERSION;
const RA2WEB_GAMERES_CACHE = "ra2web-gameres-" + RA2WEB_SW_VERSION;
const RA2WEB_PRECACHE_URLS = ["/","/index.html","/manifest.webmanifest","/js/app.js?v=0.86.1-r7695e77-d0bc1d756","/js/vendor.js?v=0.86.1-r7695e77-d0bc1d756","/res/werhdexp.mix?v=0.86.1-r7695e77-d0bc1d756","/config.ini?v=0.86.1-r7695e77-d0bc1d756","/res/overlay/art.ini?v=0.86.1","/res/overlay/modcd.ini?v=0.86.1","/res/overlay/mpbattle.ini?v=0.86.1","/res/overlay/mpcoop.ini?v=0.86.1","/res/overlay/mpduel.ini?v=0.86.1","/res/overlay/mpfreeforallmd.ini?v=0.86.1","/res/overlay/mpmeat.ini?v=0.86.1","/res/overlay/mpmodes.ini?v=0.86.1","/res/overlay/mpmw.ini?v=0.86.1","/res/overlay/mpnaval.ini?v=0.86.1","/res/overlay/mpteammd.ini?v=0.86.1","/res/overlay/mpunholy.ini?v=0.86.1","/res/overlay/nodogengikills.ini?v=0.86.1","/res/overlay/ra2.csf?v=0.86.1","/res/overlay/rules.ini?v=0.86.1","/res/overlay/soundcd.ini?v=0.86.1","/res/overlay/ui.ini?v=0.86.1"];
