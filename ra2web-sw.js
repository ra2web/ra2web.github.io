const RA2WEB_SW_VERSION = "0.86.4-rbd84169-d6c831a38";
const RA2WEB_APP_CACHE = "ra2web-app-" + RA2WEB_SW_VERSION;
const RA2WEB_GAMERES_CACHE = "ra2web-gameres-" + RA2WEB_SW_VERSION;
const RA2WEB_PRECACHE_URLS = ["/","/index.html","/manifest.webmanifest","/js/app.js?v=0.86.4-rbd84169-d6c831a38","/js/vendor.js?v=0.86.4-rbd84169-d6c831a38","/res/werhdexp.mix?v=0.86.4-rbd84169-d6c831a38","/config.ini?v=0.86.4-rbd84169-d6c831a38","/res/overlay/art.ini?v=0.86.4","/res/overlay/modcd.ini?v=0.86.4","/res/overlay/mpbattle.ini?v=0.86.4","/res/overlay/mpcoop.ini?v=0.86.4","/res/overlay/mpduel.ini?v=0.86.4","/res/overlay/mpfreeforallmd.ini?v=0.86.4","/res/overlay/mpmeat.ini?v=0.86.4","/res/overlay/mpmodes.ini?v=0.86.4","/res/overlay/mpmw.ini?v=0.86.4","/res/overlay/mpnaval.ini?v=0.86.4","/res/overlay/mpspecial.ini?v=0.86.4","/res/overlay/mpteammd.ini?v=0.86.4","/res/overlay/mpunholy.ini?v=0.86.4","/res/overlay/nodogengikills.ini?v=0.86.4","/res/overlay/ra2.csf?v=0.86.4","/res/overlay/rules.ini?v=0.86.4","/res/overlay/soundcd.ini?v=0.86.4","/res/overlay/ui.ini?v=0.86.4"];
