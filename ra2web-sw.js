const RA2WEB_SW_VERSION = "0.86.0-r2e3b64c-d679a90e8";
const RA2WEB_APP_CACHE = "ra2web-app-" + RA2WEB_SW_VERSION;
const RA2WEB_GAMERES_CACHE = "ra2web-gameres-" + RA2WEB_SW_VERSION;
const RA2WEB_PRECACHE_URLS = ["/","/index.html","/manifest.webmanifest","/js/app.js?v=0.86.0-r2e3b64c-d679a90e8","/js/vendor.js?v=0.86.0-r2e3b64c-d679a90e8","/res/werhdexp.mix?v=0.86.0-r2e3b64c-d679a90e8","/config.ini?v=0.86.0-r2e3b64c-d679a90e8","/res/overlay/art.ini","/res/overlay/modcd.ini","/res/overlay/mpbattle.ini","/res/overlay/mpcoop.ini","/res/overlay/mpduel.ini","/res/overlay/mpfreeforallmd.ini","/res/overlay/mpmeat.ini","/res/overlay/mpmodes.ini","/res/overlay/mpmw.ini","/res/overlay/mpnaval.ini","/res/overlay/mpteammd.ini","/res/overlay/mpunholy.ini","/res/overlay/nodogengikills.ini","/res/overlay/ra2.csf","/res/overlay/rules.ini","/res/overlay/soundcd.ini","/res/overlay/ui.ini"];
