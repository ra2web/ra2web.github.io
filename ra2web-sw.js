const RA2WEB_SW_VERSION = "0.82.9-r64127fa-d3b29376d";
const RA2WEB_APP_CACHE = "ra2web-app-" + RA2WEB_SW_VERSION;
const RA2WEB_GAMERES_CACHE = "ra2web-gameres-" + RA2WEB_SW_VERSION;
const RA2WEB_IMMUTABLE_PREFIXES = ["/assets/releases/","/runtime/releases/","/res/werhd/releases/","/assets/releases/0.82.9-r64127fa-d3b29376d/","/runtime/releases/0.82.9-r64127fa-d3b29376d/"];
